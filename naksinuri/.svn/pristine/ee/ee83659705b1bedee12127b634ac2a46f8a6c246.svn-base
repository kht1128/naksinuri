	...
	<div id="container">
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea"> 
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/survey/survey/list.do" class="survey_now on">진행중인 설문조사</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/survey/survey/endlist.do"  class="survey_end">종료된 설문조사</a></li>
					</ul>
				</div>
				<!-- } 탭 영역 -->
				...
				<div class="t_list_area">
					...
					<table class="t_list">
						...
						<c:forEach var="item" items="${select_list}">
							<tr>
								<td align="center"><input type="checkbox" name="delYn" class="check2" value="${item.sv_id}"></td>
						...
						<c:if test="${fn:length(select_list) eq 0}">
							<tr>
								<td class="text-center" colspan="8">정보가 없습니다.</td>
							</tr>
						</c:if>
						</tbody>
					</table>
