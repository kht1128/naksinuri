...
<%@include file="../layout/newHead_sub.jsp"%>
...
<%-- 							</c:if> --%>
				...
				<div id="btnArea">
					<ul class="floats">	
						...
						<li class="fr">
							<a href="./listmobile.do" class="btn_list btn_gray" title="목록가기" >목록</a>
						</li>
					</ul>
				</div>
			</section>
...
<%@include file="../layout/tail.sub.jsp"%>
...
<script type="text/javascript">
	...
	$('.btnSharelink').click(function() {
		...
		var pl3 = $(this).attr('data-pl3') + "mobile";
