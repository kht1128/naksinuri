...
public class EgovFileScrty {
	...
	//보안키 전용
	public static String security(String target, String key) throws Exception {
		...
		hashValue = md.digest(target.getBytes());
    ...
    public static String encryptPassword(String password, String id) throws Exception {
		...
		System.out.println("password.getBytes():"+password.getBytes());
