...
<div id="fishjobList" class="content respon2">
	...
	<div id="btnArea" class="noupline" style="margin:10px;">
		<ul class="floats">
			<li>
	...
	<div class="board_list">
		<table class="list_tbl" style="width:auto;">
			<colgroup>
				<col width="150"/>
				<col width="120" />
				<col width="120" />
...
<script>
	function detail_view(idx,bo_sn,mbr_group){
		...
		var url = "/sosig/congress/m/mbr_detail.do";
		window.open("about:blank","mbr_detail","width=800,height=800,scrollbars=yes");
		$('#bo_sn').val(bo_sn);
		$('#idx').val(idx);
