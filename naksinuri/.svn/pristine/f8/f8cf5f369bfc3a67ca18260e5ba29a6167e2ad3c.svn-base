...
<input type="hidden" name="bo_type" value="campaign" />
				...
				<div class="padding_box">
					<table class="t_write" id="ftable">
						...
						<tbody>							
							...
							<tr>
								<th>기간</th>
								<td><input type="text" name="bo_start_dt" id="bo_start_dt" class="frm_input" value="${info.bo_start_dt}"/> ~ <input type="text" name="bo_end_dt" id="bo_end_dt" class="frm_input" value="${info.bo_end_dt}"/> </td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea name="bo_content" id="bo_content"  class="frm_input"  style="WIDTH: 100%;HEIGHT:600px">${info.bo_content}</textarea></td>
							</tr>		
							<tr>
								<th>대표이미지</th>
								<c:choose>
							...
							<c:if test="${(filelist eq null) or fn:length(filelist)<10 }">
								<tr id="file_0">
