	...
	<div id="customerSound" class="content respon3">
		<section id="writeForm" class="write_box">
			...
			<dl>
				...
				<dd><input type="text" size="100" class="write_input" placeholder="상호명을 입력해주세요." id="co_nm" name="co_nm" value="${co_nm}" title="상호명"/></dd>
			</dl>
			<dl>
				<dt><span class="colorRed">*</span> 제목</dt>			
				<dd><input type="text" size="100" class="write_input" placeholder="제목을 입력해주세요." id="report_subject" name="report_subject" title="제목"/></dd>
			</dl>
	
			<dl>
				<dt><span class="colorRed">*</span> 작성자</dt>
				<dd><input type="text" size="50" class="write_input" placeholder="작성자를 입력해주세요." id="report_writer" name="report_writer" title="작성자"/>
...
<!-- 			</dl> -->
			...
			<div id="btnArea">
				<ul class="floats">
					<a href="#;" class="btn_request btn_blue" onclick="submitContents()" title="확인">확인</a>
					<a href="/index.do" class="btn_prev btn_white" title="취소">취소</a></li>
				</ul>
			</div>
		</section>
	</div>
