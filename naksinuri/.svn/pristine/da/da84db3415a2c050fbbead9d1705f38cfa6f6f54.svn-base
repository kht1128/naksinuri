...
//for문 끝 
	...
	//for문 끝 
		...
		$('#end_dt').datepicker({dateFormat : 'yy-mm-dd'});
			...
			$.ajax({
				type:"GET",
				url :'/admin/getUser_BrowserInfo1.do',
				dataType: 'json',
				contentType: "application/json;charset=UTF-8",
				async: true,
				success: function(data, status, xhr) {
