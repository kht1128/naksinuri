		...
		<section id="privacyCon">
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							...
							<tr>
								...
								<td>군산대학교산학협력단</td>
								<td>063-469-7571</td>
								<td rowspan="4">낚시전문교육 업무 수행을 위한<br><span class="underBold-red">교육대상자 정보 처리</span></td>
							</tr>
							<tr>
								<td>3</td>
								<td>전남대학교산학협력단<br>여수산학협력본부</td>
								<td>061-659-6905</td>
							</tr>
							<tr>
								<td>4</td>
			...
			<div class="con">
				...
				<div class="downloadbox mgt30 text-center">
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','4')" class="">[별지 제8호]<br>개인정보(열람, 정정·삭제, 처리정지) 요구서</a>
			...
			<div class="con">
				...
				<p>▶ 행정안전부 개인정보보호 종합지원 포털 → 민원마당 → 개인정보 열람등 요구(공공아이핀을 통한 실명인증 필요)</p>
			</div>
			<div class="con">
			...
			<div class="con">
				...
				<p class="dottedbox">① 이 개인정보 처리방침은 2020. 03. 19. 부터   적용됩니다.</p>
