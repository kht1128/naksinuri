...
<c:set var="pageName" value="dignity" />
...
<%@include file="../admin_leftTab.jsp"%>
	...
	<div id="container">
		...
		<div id="content">			
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 낚시의 품격 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
