...
<div class="content respon3">
	<section id="shortcutForm" class="w100">
		<!-- <h2 class="line-hi3">교육 서비스 제공을 위한 개인정보 수집·이용 동의서<br>(법인대표자, 교육책임자)</h2> -->
		<div class="w50 d-inline-block back write_box">
			<h2 class="line-hi3"><b class="blue">낚시터</b> 법인사업장 교육책임자 지정</h2>
			<button class="btn btn-outline btn-default btn-lg font18 float-right" onclick="shortcut('CIDN010200');">개인정보 수집·이용동의 바로가기 ></button>
		</div>
		<div class="w50 d-inline-block write_box">
			<h2 class="line-hi3"><b class="blue">낚시어선</b> 법인사업장 교육책임자 지정</h2>
			<button class="btn btn-outline btn-default btn-lg font18 float-right" onclick="shortcut('CIDN010300');">개인정보 수집·이용동의 바로가기 ></button>
		</div>
	</section>
	<section id="writeForm" class="write_box hidden">
		<h2 class="line-hi3" id="title">교육 서비스 제공을 위한 개인정보 수집·이용 동의서<br>(법인대표자, 교육책임자)</h2>
		<div class="agree_box">
...
function shortcut(ECB_DTL_CD){
	...
	if(ECB_DTL_CD == "CIDN010200") {
		document.getElementById('title').innerHTML = "낚시터 교육 서비스 제공을 위한 개인정보 수집·이용 동의서<br>(법인대표자, 교육책임자)";
	} else {
		document.getElementById('title').innerHTML = "낚시어선 교육 서비스 제공을 위한 개인정보 수집·이용 동의서<br>(법인대표자, 교육책임자)";
	}
...
$(".clk_btn_act").click(function() {
	...
	var form = document.getElementById('infoForm');
	form.action = "/educenter/rmndr/cpr_bplc.do";
