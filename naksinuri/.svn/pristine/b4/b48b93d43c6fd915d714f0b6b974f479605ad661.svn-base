...
<!-- Page -->
<div class="page vertical-align text-center bg-teal-600" data-animsition-in="fade-in" data-animsition-out="fade-out">>
	<div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
		<div class="panel">
      		<div class="panel-body">
        		<div class="brand">
          			<!-- <img class="brand-img" src="/common/img/logo_edu.png" alt="...">  -->
          			<h1 class="blue-600">낚시전문교육 CTI</h1>
          			<h2 class="brand-text font-size-18 mt-30 mb-10">로그인이 필요한 서비스입니다.</h2>
        		</div>
        		...
        		<form id="smsAuthForm" name="smsAuthForm" onsubmit="return go_step();" method="post">
					...
					<input type="hidden" name="admin_page_name" value="cti">
					...
					<c:choose>
						...
						<c:otherwise>
				        	...
				        	<div class="form-group">
				          		<label class="sr-only" for="userpasswd">비밀번호</label>
	...
	<script>
		...
		function go_step() {
			...
			if(isCheck){
				...
				frm.action = '/cti/member/login_act.do';
			}
