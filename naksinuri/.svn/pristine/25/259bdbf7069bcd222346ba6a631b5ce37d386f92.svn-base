...
@media (max-width: 1000px) {
  /* 특정 사이즈(예: 768px) 밑으로 내려갈 때 호버 기능 끄기 */
  .label_info:hover dl {
    display: none;
  }
...
<section><img src="/naksinuri_original/images/policy/side_L.png" /></section>
	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
			<div class="con" style="border: 1px solid; background: white; padding: 10px; height: auto; width: auto; display: flex; align-items: center;">
			  <img style="width: 150px; height: 92px;" src="/naksinuri_original/images/policy/ico_fiparang05.png" alt="fiparang" />
			  <div>
			  	<br>
			...
			<div  class="con">
    				...
    				주요 개인정보 처리 표시(라벨링)
    				<img style="width: 112px; height: 143px; margin-left: 5px;" src="/naksinuri_original/images/policy/adong1.png" alt="adong" />
					</h3>
			...
			<div class="pvc_infoList">
			    <ul>
			        ...
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step03" class="icon3"><span>개인정보의 제3자 제공</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step04" class="icon4"><span>개인정보처리의 위탁</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step05" class="icon5"><span>정보주체와 법정대리인의 권리&middot;의무 및 행사방법</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step06" class="icon6"><span>처리하는 개인정보 항목</span></a></li>
			        ...
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step08" class="icon8"><span>개인정보의 안전성 확보조치</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step09" class="icon9"><span>개인정보 자동수집장치의 설치&middot;운영 및 거부에 관한 사항</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step10" class="icon10"><span>개인정보 보호책임자 및 담당자</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step11" class="icon11"><span>개인정보를 열람청구</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step12" class="icon12"><span>권익침해 구제방법</span></a></li>
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step13" class="icon13"><span>개인정보 처리방침 변경</span></a></li>
			    </ul>
			</div>
			...
			<div>
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_01.png" alt="1조" />제1조(개인정보의 처리목적)</h3>
			...
			<div id="step02" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_02.png" alt="2조" />제2조(개인정보의 처리 및 보유기간)</h3>
				<p class="dottedbox">
			...
			<div id="step03" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_03.png" alt="3조" />제3조(개인정보의 제3자 제공)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="adong" /></h3>
			...
			<div id="step04" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_04.png" alt="4조" />제4조(개인정보처리의 위탁)</h3>
					...
					<caption>개인정보처리의 위탁 리스트</caption>
						...
						<tbody>
							...
							<tr>
								...
								<td>한국해양수산연수원</td>
								<td>051-624-4521</td>
								<td rowspan="3">낚시전문교육 업무 수행을 위한<br><span class="underBold-red">교육대상자 정보 처리</span></td>
								<td>O</td>
							</tr>
							<!-- <tr>
								<td>3</td>
			...
			<div id="step05" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_05.png" alt="5조" />제5조(정보주체와 법정대리인의 권리·의무 및 행사방법)</h3>
			...
			<div id="step06" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_06.png" alt="6조" />제6조(처리하는 개인정보 항목)</h3>
			...
			<div id="step07" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_07.png" alt="7조" />제7조(개인정보의 파기)</h3>
			...
			<div id="step08" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_08.png" alt="8조" />제8조(개인정보의 안전성 확보조치)<img style="width: 103px; height: 130px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang02.png" alt="fiparang2" /></h3>
			...
			<div id="step09" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_09.png" alt="9조" />제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h3>
			...
			<div id="step10" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_10.png" alt="10조" />제10조(개인정보 보호책임자 및 담당자)</h3>
				...
				<table class="basic_tbl mgt10px text-center">
					<caption>개인정보 보호책임자 및 담당자 리스트</caption>
						...
						<tbody>
							<tr>
								<td class="bold">개인정보 보호책임자<img style="width: 15px; height: 25px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang04.png" alt="fiparang4" /></td>
								<td class="bold">정보화센터</td>
								<td class="bold">안경호</td>
								<td class="bold">02-6098-0751</td>
								<td class="bold">akh059@fipa.or.kr</td>
							</tr>
							<tr>
								<td class="bold">개인정보 보호담당자<img style="width: 15px; height: 25px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang02.png" alt="fiparang2" /></td>
								<td class="bold">정보화센터</td>
								<td class="bold">이정환</td>
								<td class="bold">02-6098-0752</td>
								<td class="bold">ljh028@fipa.or.kr</td>
							</tr>
						</tbody>
					</table>
			...
			<div id="step11" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_11.png" alt="11조" />제11조(개인정보 열람청구)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="adong" /></h3>
				...
				<table class="basic_tbl mgt10px text-center">
					<caption>개인정보 열람청구 리스트</caption>
						...
						<tbody>
							<tr>
								<td class="bold">개인정보 열람청구 책임자<img style="width: 15px; height: 25px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang04.png" alt="fiparang4" /></td>
								<td class="bold">교육운영팀</td>
								<td class="bold">김민성</td>
								<td class="bold">02-6098-0851</td>
								<td class="bold">kms@fipa.or.kr</td>
							</tr>
							<tr>
								<td class="bold">개인정보 열람청구 담당자<img style="width: 15px; height: 25px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang02.png" alt="fiparang2" /></td>
								<td class="bold">교육운영팀</td>
			...
			<div id="step12" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_12.png" alt="12조" />제12조(권익침해 구제방법)</h3>
			...
			<div id="step13" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_13.png" alt="13조" />제13조(개인정보 처리방침 변경)</h3>
				<p class="dottedbox">① 이 개인정보 처리방침은 <span class="bold">2023. 06. 30.</span>부터   적용됩니다.</p>
				<p class="dottedbox">② 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.</p>
			</div>
			<a href="/policy/privacy20230630.do" class="bold">- 2022. 07. 19 ~ 2023. 06. 30 적용</a>
			...
			<div style="text-align:center; margin-top:20px;">
				<img style="width: 178px; height: 110px; animation:bounce .7s ease infinite alternate;" src="/naksinuri_original/images/policy/ico_fiparang05.png" alt="fiparang" />
			</div>
...
$(document).ready(function(){
    ...
    <section><img src="/naksinuri_original/images/policy/side_R.png" /></section>
</article>
