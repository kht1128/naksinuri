		...
		<form:form commandName="supform" id="supform" method="post" enctype="multipart/form-data" >
			...
			<section id="basicform" class="basic_formbox mgt30px">
				...
				<c:if test="${info.nak_id eq NULL }">
					<dl>
						...
						<dd>
							<ul class="choicebox floats">
								...
								<li><input type="radio" id="riverfishing" name="fishing_type" value="riverfishing" OnClick="window.location.href='/info/riverfishing.do';" checked tabindex="-1" />
					...
					<dl>
						...
						<dd>
							<ul class="choicebox2 floats">
								<li><input type="checkbox" id="checking1" name="co_info" value="민물낚시터(실외)" <c:if test ="${fn:contains(info.co_info,'민물낚시터(실외)')}">checked</c:if> tabindex="-1" /><label for="checking1"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking1').click();}"></span>민물낚시터(실외)</label></li>
								<li><input type="checkbox" id="checking2" name="co_info" value="민물낚시터(실내)" <c:if test ="${fn:contains(info.co_info,'민물낚시터(실내)')}">checked</c:if> tabindex="-1" /><label for="checking2"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking2').click();}"></span>민물낚시터(실내)</label></li>
								<li><input type="checkbox" id="checking3" name="co_info" value="낚시까페" <c:if test ="${fn:contains(info.co_info,'낚시까페')}">checked</c:if> tabindex="-1" /><label for="checking3"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking3').click();}"></span>낚시까페</label></li>
								<li><input type="checkbox" id="checking4" name="co_info" value="민물수상좌대" <c:if test ="${fn:contains(info.co_info,'민물수상좌대')}">checked</c:if> tabindex="-1" /><label for="checking4"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking4').click();}"></span>민물수상좌대</label></li>
								<li><input type="checkbox" id="checking5" name="co_info" value="민물낚시공원" <c:if test ="${fn:contains(info.co_info,'민물낚시공원')}">checked</c:if> tabindex="-1" /><label for="checking5"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking5').click();}"></span>민물낚시공원</label></li>
								<li><input type="checkbox" id="checking6" name="co_info" value="민물낚시체험장" <c:if test ="${fn:contains(info.co_info,'민물낚시체험장')}">checked</c:if> tabindex="-1" /><label for="checking6"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#checking6').click();}"></span>민물낚시체험장</label></li>
					...
					<dl>
						<dt>상호명</dt>
						<dd><input type="text" name="co_nm" id="co_nm" class="naksi_input" value="${info.co_nm}" title="상호명"/></dd>
					</dl>
					<dl>
						<dt>대표자</dt>
					...
					<dl>
						<dt>일반전화</dt>
						<dd>
							<select class="naksi_select" name="co_phone1" title="전화번호앞자리 선택옵션(02,031,032,033,041,042,043,051,052,053,054,055,061,062,063,064,070)">
							...
							<input type="text" class="naksi_input" name="co_phone2" value="${info.co_phone2}" maxlength="4" size="7" title="전화번호 가운데 번호"/> - 
							<input type="text" class="naksi_input" name="co_phone3" value="${info.co_phone3}" maxlength="4" size="7" title="전화번호 끝 번호"/>
					...
					<dl>
						<dt>휴대전화</dt>
						<dd>
							<select class="naksi_select" name="co_hphone1" id="co_hphone1" title="휴대전화 앞번호 선택옵션(010,011,016,017,018,019)">
							...
							<input type="text" class="naksi_input" name="co_hphone2" id="co_hphone2" value="${info.co_hphone2}" maxlength="4" size="7" title="휴대전화 가운데 번호"/> - 
							<input type="text" class="naksi_input" name="co_hphone3" id="co_hphone3" value="${info.co_hphone3}" maxlength="4" size="7" title="휴대전화 가운데 번호"/>
					...
					<dl>
						<dt>휴대전화2</dt>
						<dd>
							<select class="naksi_select" name="co_2hphone1" title="휴대전화 앞번호 선택옵션(010,011,016,017,018,019)">
							...
							<input type="text" class="naksi_input" name="co_2hphone2" id="co_2hphone2" value="${info.co_2hphone2}" maxlength="4" size="7" title="휴대전화 가운데 번호"/> - 
							<input type="text" class="naksi_input" name="co_2hphone3" id="co_2hphone3" value="${info.co_2hphone3}" maxlength="4" size="7" title="휴대전화 가운데 번호"/>
					...
					<dl>
						...
						<dd class="multi_input">
							<input type="text" class="naksi_input readonly" id="newpostcode" name="co_addr_1" value="${info.co_addr_1}" readonly size="7" title="우편번호"/><a href="#;" class="basicBox bgGray zipcodeBox" onclick="newaddress()" title="주소검색">주소검색</a><br />
							...
							<input type="text" id="newaddress1" name="co_addr_2" value="${info.co_addr_2}" readonly class="naksi_input w100" title="주소"/><br />
							<input type="text" id="newaddress2" name="co_addr_3" value="${info.co_addr_3}" class="naksi_input w100" placeholder="상세주소" title="상세주소"/>
					...
					<dl>
						<dt>홈페이지</dt>
						<dd class="multi_input">
							<input type="text" class="naksi_input w100" name="co_web" title="홈페이지주소" value=<c:choose><c:when test="${info.co_web eq null }">"http://"</c:when><c:otherwise>"${info.co_web}"</c:otherwise></c:choose> />
						</dd>
					</dl>
				</div>
			</section>
			...
			<section id="shipform" class="basic_formbox mgt30px">
				...
				<div class="writeBox">
					...
					<dl>
						<dt>오시는 길</dt>
						<dd class="multi_input">
							<input type="text" class="naksi_input readonly" name="co_addr2_1" value="${info.co_addr2_1}" id="busipostcode" readonly size="7" title="우편번호"/><a href="#;" class="basicBox bgGray zipcodeBox" onclick="busiaddress()" title="오시는 길 주소검색">주소검색</a>
							...
							<input type="text" id="busiaddress1" name="co_addr2_2" value="${info.co_addr2_2}" readonly class="naksi_input w100" title="오시는 길 주소"/><br />
							<input type="text" id="busiaddress2" name="co_addr2_3" value="${info.co_addr2_3}" class="naksi_input w100" placeholder="상세주소" title="오시는 길 상세주소"/>
							<input type="hidden" name="co_addr2">
						</dd>						
					</dl>
					<dl>
						<dt>수용인원</dt>
						<dd><input type="text" class="naksi_input" name="co_psg" id="co_psg" value="${info.co_psg}" title="수용인원"/> 명</dd>
					</dl>
					<dl>
						<dt>이용시간</dt>
						<dd>
							<input type="text" class="naksi_input" name="co_stm" id="co_stm" value="${info.co_stm}" size="10" placeholder="예) 오전 7시" title="이용시간 예) 오전 7시"/> ~ 
							<input type="text" class="naksi_input" name="co_etm" id="co_etm" value="${info.co_etm}" size="10" placeholder="오후 4시" title="이용시간 예) 오후 4시"/>
						</dd>
					</dl>
					<dl>
						<dt>이용료</dt>
						<dd>
							...
							<ul id="charul">
								<li id="charli_0" style="padding:5px 0">
									...
									<label for="chart_0"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#chart_0').click();}"></span>조건</label>&nbsp;&nbsp;<input type="text" class="naksi_input price_input" size="10" name="reco_prctp" id="reco_prctp_0" placeholder="예) 오전낚시" title="조건 예)오전낚시"/>&nbsp;&nbsp;
							...
							<a href="#;" class="basicBox bgGray" onclick="insert()" title="이용료 추가">이용료 추가</a>
							<a href="#;" class="basicBox zipcodeBox" onclick="del()" title="이용료 삭제">이용료 삭제</a>
						</dd>
					</dl>
					...
					<dl>
						...
						<dd>
							<ul class="choicebox floats">
								<li><input type="checkbox" id="aircon" name="co_fct" value="에어컨"		<c:if test ="${fn:contains(info.co_fct,'에어컨')}">checked</c:if> tabindex="-1" /><label for="aircon"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#aircon').click();}"></span>에어컨</label></li>
								<li><input type="checkbox" id="toilet" name="co_fct" value="화장실" 		<c:if test ="${fn:contains(info.co_fct,'화장실')}">checked</c:if> tabindex="-1" /><label for="toilet"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#toilet').click();}"></span>화장실</label></li>
								<li><input type="checkbox" id="lifejacket" name="co_fct" value="구명조끼" 	<c:if test ="${fn:contains(info.co_fct,'구명조끼')}">checked</c:if> tabindex="-1" /><label for="lifejacket"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#lifejacket').click();}"></span>구명조끼</label></li>
								<li><input type="checkbox" id="liferope" name="co_fct" value="구명밧줄" 	<c:if test ="${fn:contains(info.co_fct,'구명밧줄')}">checked</c:if> tabindex="-1" /><label for="liferope"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#liferope').click();}"></span>구명밧줄</label></li> 
								<li><input type="checkbox" id="insurance" name="co_fct" value="보험" 		<c:if test ="${fn:contains(info.co_fct,'보험')}">checked</c:if> tabindex="-1" /><label for="insurance"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#insurance').click();}"></span>보험</label></li>
								<li><input type="checkbox" id="heating" name="co_fct" value="난방" 		<c:if test ="${fn:contains(info.co_fct,'난방')}">checked</c:if> tabindex="-1" /><label for="heating"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#heating').click();}"></span>난방</label></li>
								<li><input type="checkbox" id="fireex" name="co_fct" value="소화기" 		<c:if test ="${fn:contains(info.co_fct,'소화기')}">checked</c:if> tabindex="-1" /><label for="fireex"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#fireex').click();}"></span>소화기</label></li>
								<li><input type="checkbox" id="shade" name="co_fct" value="그늘막" 		<c:if test ="${fn:contains(info.co_fct,'그늘막')}">checked</c:if> tabindex="-1" /><label for="shade"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#shade').click();}"></span>그늘막</label></li>
								<li><input type="checkbox" id="diningroom" name=co_fct value="식당" 		<c:if test ="${fn:contains(info.co_fct,'식당')}">checked</c:if> tabindex="-1" /><label for="diningroom"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#diningroom').click();}"></span>식당</label></li>
								<li><input type="checkbox" id="coffee" name="co_fct" value="커피" 		<c:if test ="${fn:contains(info.co_fct,'커피')}">checked</c:if> tabindex="-1" /><label for="coffee"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#coffee').click();}"></span>커피</label></li>
								<li><input type="checkbox" id="shop" name="co_fct" value="매점" 			<c:if test ="${fn:contains(info.co_fct,'매점')}">checked</c:if> tabindex="-1" /><label for="shop"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#shop').click();}"></span>매점</label></li>
								<li><input type="checkbox" id="parking" name="co_fct" value="주차장" 		<c:if test ="${fn:contains(info.co_fct,'주차장')}">checked</c:if> tabindex="-1" /><label for="parking"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#parking').click();}"></span>주차장</label></li>
								<li><input type="checkbox" id="room" name="co_fct" value="숙소" 			<c:if test ="${fn:contains(info.co_fct,'숙소')}">checked</c:if> tabindex="-1" /><label for="room"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#room').click();}"></span>숙소</label></li>
								<li><input type="checkbox" id="restroom" name="co_fct" value="휴게실" 	<c:if test ="${fn:contains(info.co_fct,'휴게실')}">checked</c:if> tabindex="-1" /><label for="restroom"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#restroom').click();}"></span>휴게실</label></li>
								<li><input type="checkbox" id="refrg" name="co_fct" value="냉장고" 		<c:if test ="${fn:contains(info.co_fct,'냉장고')}">checked</c:if> tabindex="-1" /><label for="refrg"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#refrg').click();}"></span>냉장고</label></li>
								<li><input type="checkbox" id="tv" name="co_fct" value="TV" 			<c:if test ="${fn:contains(info.co_fct,'TV')}">checked</c:if> tabindex="-1" /><label for="tv"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#tv').click();}"></span>TV</label></li>
								<li><input type="checkbox" id="internet" name="co_fct" value="인터넷"	 	<c:if test ="${fn:contains(info.co_fct,'인터넷')}">checked</c:if> tabindex="-1" /><label for="internet"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#internet').click();}"></span>인터넷</label></li>
								<li><input type="checkbox" id="kitchen" name="co_fct" value="취사장" 		<c:if test ="${fn:contains(info.co_fct,'취사장')}">checked</c:if> tabindex="-1" /><label for="kitchen"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#kitchen').click();}"></span>취사장</label></li>
								<li><input type="checkbox" id="campsite" name="co_fct" value="야영지" 	<c:if test ="${fn:contains(info.co_fct,'야영지')}">checked</c:if> tabindex="-1" /><label for="campsite"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#campsite').click();}"></span>야영지</label></li>
								<li><input type="checkbox" id="fishingshop" name="co_fct" value="낚시점" 	<c:if test ="${fn:contains(info.co_fct,'낚시점')}">checked</c:if> tabindex="-1" /><label for="fishingshop"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#fishingshop').click();}"></span>낚시점</label></li>
								<li><input type="checkbox" id="showerroom" name="co_fct" value="샤워실" 	<c:if test ="${fn:contains(info.co_fct,'샤워실')}">checked</c:if> tabindex="-1" /><label for="showerroom"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#showerroom').click();}"></span>샤워실</label></li>
								<li><input type="checkbox" id="fan" name="co_fct" value="선풍기" 			<c:if test ="${fn:contains(info.co_fct,'선풍기')}">checked</c:if> tabindex="-1" /><label for="fan"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#fan').click();}"></span>선풍기</label></li>
								<li><input type="checkbox" id="burner" name="co_fct" value="버너" 		<c:if test ="${fn:contains(info.co_fct,'버너')}">checked</c:if> tabindex="-1" /><label for="burner"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#burber').click();}"></span>버너</label></li>
								<li><input type="checkbox" id="grill" name="co_fct" value="숯불그릴" 		<c:if test ="${fn:contains(info.co_fct,'숯불그릴')}">checked</c:if> tabindex="-1" /><label for="grill"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#grill').click();}"></span>숯불그릴</label></li>
								<li><input type="checkbox" id="beding" name="co_fct" value="침구" 		<c:if test ="${fn:contains(info.co_fct,'침구')}">checked</c:if> tabindex="-1" /><label for="beding"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#beding').click();}"></span>침구</label></li>
								<li><input type="checkbox" id="rod" name="co_fct" value="낚시대" 			<c:if test ="${fn:contains(info.co_fct,'낚시대')}">checked</c:if> tabindex="-1" /><label for="rod"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#rod').click();}"></span>낚시대</label></li>
							</ul>
						</dd>
					</dl>
					<dl>
						<dt>사업장 소개</dt>
						<dd>
							<textarea placeholder="예) 친절하고 깨끗한 환경, 확실한 조과 보장" class="basic_textarea" style="width:99%" name="co_intro" id="co_intro" cols="60" rows="10" title="사업장 소개">${info.co_intro }</textarea>	
						</dd>
					</dl>
					<dl>
						<dt>대표 이미지</dt>
					...
					<dl>
							...
							<ul class="imgul" id="imgul">
					          <c:forEach var="naksinurifileVO" items= "${filelist}" varStatus="status">
								...
								<%--							
					       		...
					       		--%>
					       			<input type="checkbox" id="delcheck_${naksinurifileVO.atch_file_id}_${naksinurifileVO.file_sn}" name="delcheck" value="${naksinurifileVO.atch_file_id}_${naksinurifileVO.file_sn}" title="파일삭제"/>
					       			<label for="delcheck_${naksinurifileVO.atch_file_id}_${naksinurifileVO.file_sn}"><span tabindex="0" onkeyPress="if (event.keyCode==13 || event.keyCode==32){$('#delcheck_${naksinurifileVO.atch_file_id}_${naksinurifileVO.file_sn}').click();}"></span>삭제</label>
				       			</li>
							  </c:forEach>			
							<li id="imgli_0">
						...
						<a href="#;" class="basicBox bgGray" onclick="insertimg()" title="이미지 추가">이미지 추가</a><a href="#;" class="basicBox zipcodeBox" onclick="delrow()" title="이미지 삭제">이미지 삭제</a>
						</dd>
					</dl>
				</div>
...
//				}else if($("#oldaddress1").val()==''){
		...
		$('#sup').click(function(){
			...
			if( $('input[name=nak_id]').val()=='' && document.getElementById('riverfishing').checked == false){
