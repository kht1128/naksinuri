...
<%@include file="../../layout/m/head.jsp"%>	
	...
	<div id="noFishing" class="content respon2">
		<div class="tabArea"> <!-- 탭이 3개면 class="tabArea tab3" 4개면 뭐겠냐 -->
			<ul class="floats">
				<li id="plocation"><a href="/promotion/plocation/m/list.do">낚시금지구역</a></li>
				<li id="llocation" class="on"><a href="/promotion/llocation/m/list.do">낚시제한구역</a></li>
			</ul>
		</div>
...
$('document').ready(function() {
 ...
 $("select[name^=sido]").change(function() {
	 ...
	 $.ajax({
		 type:"post",
		 url:"${contextPath}/promotion/m/llocation.do",
		 datatype:"json",
