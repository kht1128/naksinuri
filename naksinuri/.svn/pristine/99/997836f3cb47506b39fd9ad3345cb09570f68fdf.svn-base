					...
					<div class="content">
						...
						<c:if test="${(pageName ne 'notice') and (pageName ne 'policy') and(pageName ne 'campaign')}">				
							<div class="writer_box">
								<div class="pic"><img src='<c:url value='/naksinuri_original/cmm/fms/getImage.do'/>?atchFileId=<c:out value="${info.bo_sub_img}"/>&fileSn=<c:out value="0"/>'  width="100%" height="100%"  /></div>
