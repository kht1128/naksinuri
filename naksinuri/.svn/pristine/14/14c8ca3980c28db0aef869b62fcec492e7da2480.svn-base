		...
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea">
					...
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/sosig/event/trash.do">목록조회</a></li>
						...
						<li><a href="${pageContext.request.contextPath}/admin/sosig/aevent/trash.do"  class="on">이벤트 당첨발표</a></li>
<!-- 						<li><a href="#;">상세내용</a></li> -->
					</ul>
				</div>
				<!-- } 탭 영역 -->
