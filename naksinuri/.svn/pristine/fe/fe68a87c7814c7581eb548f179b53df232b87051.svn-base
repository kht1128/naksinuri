	...
	<div id="container">
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/sosig/event/list.do">목록조회</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/sosig/yevent/list.do" >진행중인 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/sosig/nevent/list.do" >종료된 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/sosig/aevent/list.do"  class="on">이벤트 당첨발표</a></li>
<!-- 						<li><a href="#;">상세내용</a></li> -->
					</ul>
				</div>
				<!-- } 탭 영역 -->
	...
	<form:form commandName="listform" id="listform" name="listform" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="evn_no" id="evn_no" value="${item.evn_no }"/>
				...
				<div align="right"><a href="#;" onclick="fncGroupListDelete()" class="btn_size1 btn_violet">삭제</a><a href="/admin/sosig/aevent/view.do" class="btn_size1 btn_violet">당첨발표 글쓰기</a></div>
				<!-- 페이지 { -->
				<div id="pagenation">
...
function view2(evn_no){
	...
	form.action="/admin/sosig/event/aevent_findCorp.do";
	form.submit();
};
