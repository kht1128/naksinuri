...
%>
   ...
   <!-- Footer -->
    <footer class="site-footer">
      <div class="site-footer-legal">© 2019 낚시전문교육 관리자</div>
    ...
    function ajaxLoadingHtmlTag() {
    	return '<div class="text-center"><div class="loader vertical-align-middle loader-ellipsis"></div></div>';
    }
    function ajaxLoadingFailHtmlTag(msg) {
    	return '<div class="text-center font-size-12">' + msg + '</div>';
    }
    </script>
