			...
			<section id="basicform" class="basic_formbox mgt30">
				...
				<c:if test="${info.nak_id eq NULL }">
					<dl>
						...
						<dd>
							<ul class="choicebox floats">
								<li><input type="radio" id="boatfishing" name="fishing_type" value="boatfishing" OnClick="window.location.href='/info/m/boatfishing.do';" checked />
								...
								<li><input type="radio" id="seafishing" name="fishing_type" value="seafishing" OnClick="window.location.href='/info/m/seafishing.do';" />
					...
					<dl>
						<dt>어선번호</dt>
						<dd>
							<input type="text" name="co_ship_num1" id="co_ship_num1" class="naksi_input" value="${info.co_ship_num1}" maxlength="7" size="7" onkeypress='SetNum(this)' onblur='SetNum(this)' />
							- 
							<input type="text" name="co_ship_num2" id="co_ship_num2" class="naksi_input" value="${info.co_ship_num2}" maxlength="7" size="7" onkeypress='SetNum(this)' onblur='SetNum(this)' />
						</dd>
					</dl>					
					<dl>
						<dt>대표자</dt>
					...
					<dl>
						...
						<dd>
							...
							<input type="text" class="naksi_input" name="co_phone2" id="co_phone2" value="${info.co_phone2}" maxlength="4" size="7"/> - 
							<input type="text" class="naksi_input" name="co_phone3" id="co_phone3" value="${info.co_phone3}" maxlength="4" size="7"/>
					...
					<dl>
						<dt>휴대전화</dt>
						<dd>
							<select class="naksi_select" name="co_hphone1" id="co_hphone1">
					...
					<dl>
						<dt>어선규모(톤)</dt>
						<dd><input type="text" class="naksi_input" name="bo_size" id="bo_size" value="${info.bo_size}" /> 톤 </dd>
					</dl>
					<dl>
						<dt>어선속도(knot)</dt>
						<dd><input type="text" name="bo_spd" id="bo_spd" class="naksi_input" value="${info.bo_spd}" /> knot</dd>
					</dl>
					<dl>
						<dt>승선인원</dt>
						<dd><input type="text" name="bo_psg" id="bo_psg" class="naksi_input" value="${info.bo_psg}" /> 명</dd>
					</dl>
					<dl>
						<dt>홈페이지</dt>
					...
					<dl>
						<dt>사업장 주소</dt>
						<dd class="multi_input">
							<input type="text" name="co_addr_1" class="naksi_input readonly" id="newpostcode" value="${info.co_addr_1}" readonly size="7" /><a href="#;" class="basicBox bgGray zipcodeBox" onclick="newaddress()">주소검색</a><br />
							...
							<input type="text" id="newaddress1" id="co_addr_2" name="co_addr_2" value="${info.co_addr_2}" readonly class="naksi_input w100" /><br />
							<input type="text" id="newaddress2" name="co_addr_3" id="co_addr_3" value="${info.co_addr_3}" class="naksi_input w100" placeholder="상세주소"/>
			...
			<section id="shipform" class="basic_formbox mgt30">
				...
				<div class="writeBox">
					...
					<dl>
						<dt>오시는 길</dt>
						<dd class="multi_input">
							<input type="text" class="naksi_input readonly" name="co_addr2_1" id="busipostcode" value="${info.co_addr2_1}" readonly size="7" /><a href="#;" class="basicBox bgGray zipcodeBox" onclick="busiaddress()">주소검색</a>
					...
					<dl>
						<dt>이용시간</dt>
						<dd>
							<input type="text" name="co_stm" id="co_stm" class="naksi_input" size="10" value="${info.co_stm}" placeholder="예) 오전 7시" /> ~ 
							<input type="text" name="co_etm" id="co_etm" class="naksi_input" size="10" value="${info.co_etm}" placeholder="오후 4시" />
						</dd>
					</dl>
					<dl>
						<dt>이용료</dt>
					...
					<dl>
						...
						<dd>
							...
							<label for="credit_p"><span></span>가능/불가능</label>
					...
					<dl>
						<dt>사업장 소개</dt>
						<dd>
							<textarea placeholder="예) 근해낚시, 먼바다낚시, 회와 매운탕제공, 낚시대여(유료)" class="basic_textarea" name="co_intro" id="co_intro" style="WIDTH: 100%;min-width:270px;" >${info.co_intro}</textarea>	
						</dd>
					</dl>
					<dl>
						<dt>대표 이미지</dt>
...
//				}else if($("#oldaddress1").val()==''){
		...
		$("#preview").click(function(){
		    ...
		    window.name = "parent_window";
		    $('#save_status').val('w');
		    var openwin = window.open('','preview', 'width=1400, height=800, scrollbars=yes, resizable=no');
