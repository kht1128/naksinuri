...
<div>
	<div id="customerSound" class="content respon3">
		<section id="writeForm" class="write_box">
			...
			<dl class="floats">
				<dt>작성자</dt>
				<dd><input type="text" class="write_input" value="${info.voc_name}" disabled/></dd>
				<dt>작성일자</dt>
				<dd><input type="text" class="basic_input w40" value="${fn:substring(info.voc_insert_dt,0,19)}" disabled/></dd>
			</dl>
			<dl class="floats">
				<dt>구분</dt>
				<dd><input type="text" class="write_input" value="${info.voc_type}" disabled/></dd>
				<dt>공개여부</dt>
				<dd>
					<c:choose>
						<c:when test="${info.voc_issecret eq '0'}">
							<input type="text" class="write_input" value="비공개" disabled/>
						</c:when>
						<c:otherwise>
							<input type="text" class="write_input" value="공개" disabled/>
						</c:otherwise>
					</c:choose>
				</dd>
			</dl>
			...
			<div id="btnArea" class="mt-0">
				<ul class="floats">
					<a href="/policy/customer_sound_list.do" class="btn_request btn_blue">목록</a>
				</ul>
			</div>
		</section>
	</div>
