	...
	<div id="container">
		...
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
						<li><a href="#;" class="cateing on">진행중인 공모전</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/gongmo/endlist.do" class="cateend">종료된 공모전</a></li>
					</ul>
				</div>
				<!-- } 탭 영역 -->
					...
					<table class="t_list">
						...
						<c:forEach var="item2" items="${noticlist }">
							<tr>
								...
								<td class="textcenter">
									<c:choose>
									 	<c:when test="${item.is_entry_y eq '1'}"><a href="#;" onclick="show_applicant('${item.bo_sn}')" class="txt_red">모집중</a></c:when>								 
