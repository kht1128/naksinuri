...
<style>
	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							<tr>
								...
								<td><span class="underBold-red">1년</span></td>
							</tr>
							<tr>
								<td class="bold">2</td>
			...
			<div class="con">
				...
				<table class="basic_tbl mgt10px text-center height71">
						...
						<tbody>
							<tr>
								<td class="bold">1</td>
								<td class="bold">시스템 운영 및<br>유지보수 업체</td>
								<td class="bold">042-471-7290</td>
							...
							<tr>
								...
								<td class="bold">낚시명예감시원 업무 수행을 위한<br>위촉대상자 정보 처리</td>
								<td class="bold">O</td>
							</tr>
						</tbody>
					</table>
			...
			<a href="/policy/privacy20220422.do" class="bold">- 2021. 08. 31 ~ 2022. 04. 22 적용</a>
