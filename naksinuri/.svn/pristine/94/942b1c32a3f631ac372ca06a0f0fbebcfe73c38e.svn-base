...
<!-- 							<li><input type="checkbox" id="san_divsion0" name="san_aag" value="협회/기관/단체" /> -->
<!-- 							<label for="san_divsion0"><span></span>협회/기관/단체</label></li> -->
...
<!-- 			<ul class="floats"> -->
<!-- 				<li>(08588) 서울특별시 금천구 가산디지털2로 53 한라시그마밸리 5층</li> -->
<!-- 				<li>TEL : 1833-7139</li> -->
<!-- 				<li>상호 : 한국어촌어항공단</li> -->
