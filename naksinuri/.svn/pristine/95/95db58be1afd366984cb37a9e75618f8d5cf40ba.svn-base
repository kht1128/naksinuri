...
<c:set var="pageName" value="riverfishing" />
...
<form:form commandName="supform" id="supform" method="post" enctype="multipart/form-data" >
	...
	<input type="hidden" name="fishing_type" value="riverfishing">
		...
		<div id="content">			
					...
					<table class="t_write">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<ul class="fish_list floats">
										<li><input type="checkbox" id="checking1" name="co_info" value="민물낚시터(실외)" <c:if test ="${fn:contains(info.co_info,'민물낚시터(실외)')}">checked</c:if> /><label for="checking1"><span></span>민물낚시터(실외)</label></li>
										<li><input type="checkbox" id="checking2" name="co_info" value="민물낚시터(실내)" <c:if test ="${fn:contains(info.co_info,'민물낚시터(실내)')}">checked</c:if> /><label for="checking2"><span></span>민물낚시터(실내)</label></li>
										<li><input type="checkbox" id="checking3" name="co_info" value="낚시까페" <c:if test ="${fn:contains(info.co_info,'낚시까페')}">checked</c:if> /><label for="checking3"><span></span>낚시까페</label></li>
										<li><input type="checkbox" id="checking4" name="co_info" value="민물수상좌대" <c:if test ="${fn:contains(info.co_info,'민물수상좌대')}">checked</c:if> /><label for="checking4"><span></span>민물수상좌대</label></li>
										<li><input type="checkbox" id="checking5" name="co_info" value="민물낚시공원" <c:if test ="${fn:contains(info.co_info,'민물낚시공원')}">checked</c:if> /><label for="checking5"><span></span>민물낚시공원</label></li>
										<li><input type="checkbox" id="checking6" name="co_info" value="민물낚시체험장" <c:if test ="${fn:contains(info.co_info,'민물낚시체험장')}">checked</c:if> /><label for="checking6"><span></span>민물낚시체험장</label></li>
									</ul>
								</td>								
							</tr>
							<tr>
							...
							<tr>
								...
								<input type="text" name="co_phone2" class="frm_input" value="${info.co_phone2}" maxlength="4" size="7" /> - 
								<input type="text" name="co_phone3" class="frm_input" value="${info.co_phone3}" maxlength="4" size="7" />
								</td>
							</tr>
							<tr>
								<th>휴대전화</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<dl>
										<dd class="multi_input">
										<input type="text" class="frm_input readonly" name="co_addr2_1" value="${info.co_addr2_1}" id="busipostcode" readonly size="7" /><a href="#;" class="btn_size1 btn_violet" onclick="busiaddress()">주소검색</a>
							...
							<tr>
								<th>수용인원</th>
								<td>
									<input type="text" class="frm_input" name="co_psg" value="${info.co_psg}" size="10"/>명
								</td>
							</tr>
							<tr>
								<th>이용시간</th>
								<td>
									<input type="text" class="frm_input" name="co_stm" value="${info.co_stm}" size="10" placeholder="예) 오전 7시" /> ~ 
									<input type="text" class="frm_input" name="co_etm" value="${info.co_etm}" size="10" placeholder="오후 4시" />
								</td>
							</tr>
							<tr>
								<th>이용료</th>
							...
							<tr>
								<th>사업장 소개</th>
								<td>
									<textarea placeholder="예) 친절하고 깨끗한 환경, 확실한 조과 보장" class="frm_textarea" name="co_intro" id="co_intro" style="width:100%;height:300px" >${info.co_intro }</textarea>								
								</td>
							</tr>
							<tr>
								<th>대표 이미지</th>
			...
			<div class="btn_area textcenter">
				...
				<c:if test="${info.co_trash eq '1' }">
					<a href="/admin/info/riverfishing/trash.do" class="btn_size2 btn_bordergray">취소</a>
				</c:if>
				...
				<c:if test="${info.co_trash eq '0' && info.nak_id ne null}">
					...
					<a href="/info/admin/riverfishing.do" class="btn_size2 btn_bordergray">취소</a>
				</c:if>
...
// 행 추가 삭제
	...
	function insertimg(){		
		if($("ul#imgul").children().size()==10){
			...
			$('#imgul').append('<li id="imgli_'+i+'"><em><input type="checkbox" id="introimage_'+i+'" name="introimage[]" /><label for="introimage_'+i+'"><span>&nbsp;</span></label></em><span><input type="file" size="30" id="file" name="file_'+(i+1)+'" accept="image/*" /><br></span></li>');
			i++;
		}
	}
	function delrow(){
