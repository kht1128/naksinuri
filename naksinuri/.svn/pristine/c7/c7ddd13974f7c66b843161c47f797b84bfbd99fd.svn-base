...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		var sPopupUrl = "/se2/photo_uploader/popup/index.do";//"./photo_uploader/popup/index.html";
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" class="se2img" data-id="{=sfid}" data-sn="{=sfsn}">';
