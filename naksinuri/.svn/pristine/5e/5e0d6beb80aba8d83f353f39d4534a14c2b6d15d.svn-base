	...
	<div id="container">
		...
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/gongmo/list.do" class="cateing">진행중인 공모전</a></li>
						<li><a href="#;" class="cateend on">종료된 공모전</a></li>
<!-- 						<li><a href="#;">상세내용</a></li> -->
					</ul>
				</div>
				<!-- } 탭 영역 -->
					...
					<table class="t_list">
						...
						<c:forEach var="item2" items="${noticlist }">
							<tr>
								...
								<td class="textcenter"><a href="#;" onclick="show_applicant('${item2.bo_sn}')" class="txt_red">참가자</a></td>
						...
						<c:forEach var="item" items="${select_list}">
							<tr>
								...
								<td class="textcenter"><a href="#;" onclick="show_applicant('${item.bo_sn}')" class="txt_red">참가자</a></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
...
function show_applicant(bo_sn){
	...
	var form = document.getElementById('listform');
	var url = "/gongmo/gongmo/list_show.do";
