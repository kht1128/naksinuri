  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <header>
        ...
        <!-- <p>해당 계정은 권한이 없어 자동로그아웃 되었습니다.<br>관리자에게 문의해주세요.</p> -->
        <p>해당 계정은 접근권한이 없습니다.<br>관리자에게 문의해주세요.</p> 
      </header>
      <p class="error-advise">아래 버튼을 이용하여 다른페이지로 이동해주세요.</p>
      <a class="btn btn-info btn-round" href="/index.do">낚시누리 홈페이지로 이동</a>
      <!-- <a class="btn btn-primary btn-round" href="/eduadm/member/login.do">로그인화면 이동</a>  -->
      <a class="btn btn-primary btn-round" href="javascript:history.back()">이전페이지로 돌아가기</a>
	  <a class="btn btn-danger btn-round" href="/eduadm/member/actionLogout.do">로그아웃 하고 다시로그인</a>
