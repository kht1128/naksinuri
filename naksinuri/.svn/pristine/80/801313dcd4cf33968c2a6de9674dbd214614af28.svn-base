...
<input type="hidden" id="bo_sido" value="${searchSido}" />
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 지역별 낚시준수사항 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
					...
					<table class="t_list">
						...
						<c:forEach var="item" items="${select_list}">
							<tr>
								...
								<td class="textcenter"><a href="#;" onclick="view2('${item.bo_sn}')">${item.bo_sido}</a></td>
