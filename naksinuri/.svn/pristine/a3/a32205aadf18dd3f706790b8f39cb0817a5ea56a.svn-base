...
public class EgovImageProcessController extends HttpServlet {
	...
	@SuppressWarnings("resource")
	@RequestMapping("/cmm/fms/getMovie.do")
	public void getMovieInf(ModelMap model, @RequestParam Map<String, Object> commandMap, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (fvo.getFileExtsn() != null && !"".equals(fvo.getFileExtsn())) {
				if ("pdf".equals(fvo.getFileExtsn().toLowerCase())) {
					...
					type = "application/" + fvo.getFileExtsn().toLowerCase();
				}
				type = "application/" + fvo.getFileExtsn().toLowerCase();

			} else {
				LOGGER.debug("Pdf fileType is null.");
			}
