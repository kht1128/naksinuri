...
<div id="wrapper">
	...
	<div id="container">
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 이벤트 당첨자발표 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
			...
			<section id="table-list">
				...
				<div id="tabarea">
					...
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/event/trash.do">목록조회</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/yevent/trash.do" >진행중인 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/nevent/trash.do" >종료된 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/aevent/trash.do"  class="on">공지사항 & 당첨자발표</a></li>
<!-- 						<li><a href="#;">상세내용</a></li> -->
					</ul>
				</div>
				<!-- } 탭 영역 -->
