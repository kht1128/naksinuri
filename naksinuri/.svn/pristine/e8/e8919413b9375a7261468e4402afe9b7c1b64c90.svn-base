...
/**edu_cpr_bplc_tb**/
public class EduAdmCprBplcVO extends EduDefaultVO {
	...
	//디비 외
	private String CD_SIGNGU_NM;		//시군구 이름
	private String MBR_SN;				//mbr_tb 고유번호
	private String MBR_ID;				//아이디
	
	
	
	public String getCD_SIGNGU_NM() {
		return CD_SIGNGU_NM;
	}
	public void setCD_SIGNGU_NM(String cD_SIGNGU_NM) {
		CD_SIGNGU_NM = cD_SIGNGU_NM;
	}
