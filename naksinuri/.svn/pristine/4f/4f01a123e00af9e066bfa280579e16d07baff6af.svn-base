...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 초보탈출하기 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
		...
		<input type="hidden" name="bo_cate" value="${bo_cate}"/>
				...
				<div class="t_list_area">
					...
					<table class="t_list">
						...
						<!-- 
							<tr>
								<td colspan="5" class="textcenter">등록된 데이터가 없습니다.</td>
							</tr>
						-->
						</tbody>
					</table>
				...
				<div align="right">
					<a href="#;" onclick="fncGroupListDelete()" class="btn_size1 btn_violet">삭제</a>
					<a href="#;" onclick="fncGroupListRestore()" class="btn_size1 btn_violet">복구</a>
				</div>
				<!-- 페이지 { -->
				<div id="pagenation">
