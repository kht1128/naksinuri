...
<c:set var="pageName" value="class" />
...
<div id="wrapper">
	...
	<div id="container">
		...
		<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 어종별낚시교실 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
	 					...
	 					<li onclick="fnSelectInfs2('루어')"><a href="#;" class="cateroo">루어낚시</a></li>
					</ul>
				</div>
				<!-- } 탭 영역 -->
