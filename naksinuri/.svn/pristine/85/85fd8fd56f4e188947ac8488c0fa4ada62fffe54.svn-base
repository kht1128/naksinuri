...
<style>
	...
	.underBold-red {text-decoration: underline;font-weight: bold;color: red; font-size: 17px;}
	.text-center, tr th {text-align: center;}
	table {word-break: break-word;}
	@media(max-width:500px){
		#privacy #privacyCon .downloadbox a {width: 100%;display: block;margin-top: 5px;}
	}
</style>
	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
			<div class="con">
				<h3>낚시누리(www.naksinuri.kr) 개인정보 처리방침</h3>
				<p>한국어촌어항공단이 해양수산부로부터 위탁받아 운영하는 낚시누리(www.naksinuri.kr)(이하 “낚시누리”)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여  다음과 같이 개인정보 처리방침을 수립․공개합니다.</p>
			</div>
			<div class="con">
				...
				<p class="dottedbox">
					② “낚시누리”가 개인정보 보호법 제32조에 따라 등록·공개하는 개인정보파일의 처리목적은 다음과 같습니다.  
				</p>
				<table class="basic_tbl mgt10px">
						...
						<tbody>
							<tr>
								...
								<td>낚시 관리 및 육성법 제47조, 시행령 제23조, 낚시전문교육 및 교육기관 지정에 관한 고시, 정보주체 동의</td>
...
<!-- 							<tr>
								...
								<td class="bold">낚시 관리 및 육성법 제46조, 낚시명예감시원 위촉 등에 관한 고시, 정보주체 동의</td>
								<td class="underBold bold">낚시명예감시원 위촉대상자의 신원 확인, 활동 이력 관리, 활동 및 관련 정책 안내, 결과 통보, 활동수당 지급</td>
							</tr> -->
							<!-- <tr>
				...
				<p class="dottedbox mgt10px"> 보다 상세한 “낚시누리”의 개인정보파일 등록사항 공개는 행정안전부 개인정보보호 종합지원 포털(www.privacy.go.kr) → 민원마당 → 개인정보열람등 요구 → 개인정보파일 목록검색 메뉴를 활용해주시기 바랍니다.   
				</p>
			</div>
			...
			<div class="con">
				...
				<p class="dottedbox">
					① “낚시누리”는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다. 
				</p>
				<p class="dottedbox">
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							<tr>
								...
								<td rowspan="2">서비스 제공 및 민원 사무 처리</td>
...
<!-- 							<tr>
								<td class="bold">2</td>
								<td class="bold">낚시명예감시원<br>위촉대상자 명단</td>
								<td class="bold"><span class="underBold-red">낚시명예감시원<br>활동기간</span></td>
							</tr> -->
						</tbody>
					</table>
			</div>
			<div class="con">
				...
				<ol style="margin-left:15px;">
					<li style="text-indent: -1em;">
						...
						<p class="margin-left7">ㆍ 정보주체 또는 그 법정대리인이 의사표시를 할 수 없는 상태에 있거나 주소불명 등으로 사전 동의를 받을 수 없는 경우로서 명백히 정보주체 또는 제3자의 급박한 생명, 신체, 재산의 이익을 위하여 필요하다고 인정되는 경우</p>
			...
			<div class="con">
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							<tr>
								<td class="bold">1</td>
								<td class="bold">시스템 운영 및 유지보수 업체</td>
								<td class="bold">02-6098-0852</td>
								<td class="bold">낚시정보종합포털 내부시스템 운영 지원 및 시스템 유지보수</td>
								<td class="bold">O</td>
							</tr>
							<tr>
								<td>2</td>
							...
							<tr>
								<td class="bold">5</td>
								<td class="bold">한국낚시단체총연합회</td>
								<td class="bold">02-494-2733</td>
								<td class="bold">낚시명예감시원 업무 수행을 위한 위촉대상자 정보 처리</td>
								<td class="bold">O</td>
							</tr>
						</tbody>
					</table>
				...
				<p class="depth2">3) 개인정보의 안전한 관리에 관한 사항: 위탁업무의 목적 및 범위, 재위탁 제한에 관한 사항, 개인정보 안전성 확보 조치에 관한 사항,
					 위탁업무와 관련하여 보유하고 있는 개인정보의 관리현황 점검 등 감독에 관한 사항, 수탁자가 준수하여야 할 의무를 위반한 경우의 손해배상 책임에 관한 사항
				</p>
			...
			<div class="con">
				...
				<div class="downloadbox mgt30 text-center">
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','4')" class="">[개인정보보호위원회 개인정보보호지침 별지 제1호]<br>개인정보(열람, 정정·삭제, 처리정지) 요구서</a>
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','3')" class="">[개인정보보호위원회 개인정보보호지침 별지 제2호]<br>위임장</a>
				</div>			
			</div>
			<div class="con">
				<h3>제6조(처리하는 개인정보 항목)</h3>
				<p>“낚시누리”는 다음의 개인정보 항목을 처리하고 있습니다.</p>
				<table class="basic_tbl mgt10">
						<colgroup>
							<col class="wp10" />
							<col class="width20"/>
							<col />
						...
						<tbody>
							<tr>
								<td class="text-center">1</td>
								<td class="text-center">낚시전문교육<br>교육대상자 명단</td>
								<td class="underBold">수강인구분, 성명, 생년월일, 주소, 휴대전화번호, 허가(등록)·신고 시·군·구명</td>
								<td class="underBold">전화번호, 낚시터·낚시어선 명칭, 허가(등록)·신고증 번호, 어선번호(낚시어선에 한함)</td>
							</tr>
<!-- 							<tr>
								<td class="text-center bold">2</td>
								<td class="text-center bold">낚시명예감시원<br>위촉대상자 명단</td>
								<td class="underBold">성명(한글, 한자, 영문), 생년월일, 사진, 주소, 이메일, 연락처(전화번호, 핸드폰), 전공, 경력, 자격 사항(면허, 자격증)</td>
								<td class="underBold">해당없음</td>
							</tr> -->
	                        <!-- <tr>
	                            <td class="text-center">2</td>
			...
			<div class="con">
				...
				<p class="dottedbox">② 정보주체로부터 동의 받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보(또는 개인정보파일)을 별도의 데이터베이스(DB)로 옮기거나 보관 장소를 달리하여 보존합니다.</p>
				<p class="dottedbox">③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</p>
				<p class="dottedbox">
				1. 파기절차
				<ol>
					<li>“낚시누리”는 개인정보 보호책임자의 책임 하에 개인정보 파기계획에 따라 다음과 같이 처리하고 있습니다.
						<p class="depth2">ㆍ개인정보의 파기보유기간이 경과한 개인정보는 종료일로부터 지체 없이 파기합니다.</p>
						<p class="depth2">ㆍ개인정보파일의 처리 목적 달성 등 그 개인정보파일이 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 지체 없이 그 개인정보파일을 파기합니다.</p>
					</li>
				</ol>
				</p> 
				<p class="dottedbox">
			...
			<div class="con">
				...
				<table class="basic_tbl mgt10 text-center">
						<colgroup>
							<col />
							<col />
							<col />
					...
					<p class="dottedbox mgt10">② 정보주체는 “낚시누리”의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. “낚시누리”는 정보주체의 문의에 대해 지체 없이 답변 및 처리해 드릴 것입니다.</p>
			</div>
			<div class="con">
				<h3>제11조(개인정보 열람청구)</h3>
				<p class="dottedbox">① 정보주체와 법정대리인은 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. “낚시누리”는 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<p>
				<p class="mgt10">▶  개인정보 열람청구 접수·처리 부서</p>
				<table class="basic_tbl mgt10 text-center">
						<colgroup>
							<col />
							<col />
						...
						<tbody>
							<tr>
								<td class="bold">개인정보 열람청구 책임자</td>
							...
							<tr>
								<td class="bold">개인정보 열람청구 담당자</td>
								<td class="bold">교육운영팀</td>
								<td class="bold">최지원</td>
								<td class="bold">02-6098-0852</td>
								<td class="bold">cjw093@fipa.or.kr</td>
							</tr>
						</tbody>
					</table>
				<p class="dottedbox mgt10">② 정보주체께서는 제1항의 열람청구 접수·처리부서 이외에, 행정안전부의 ‘개인정보보호 종합지원 포털’ 웹사이트(www.privacy.go.kr)를 통하여서도 개인정보   열람청구를 하실 수 있습니다.</p>
			...
			<div class="con">
				...
				<p class="dottedbox">① 이 개인정보 처리방침은 <span class="bold">2022. 04. 22.</span> 부터   적용됩니다.</p>
				<p class="dottedbox">② 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.</p>
			</div>
			<a href="/policy/m/privacy20220422.do">- 2021. 08. 31 ~ 2022. 04. 22 적용</a>
			<a href="/policy/m/privacy2021.do">- 2020. 8. 10 ~ 2021. 8. 30 적용</a>
			<a href="/policy/m/privacy20200809.do">- 2020. 6. 29 ~ 2020. 8. 09 적용</a>
			<a href="/policy/m/privacy2020.do">- 2020. 3. 19 ~ 2020. 6. 28 적용</a>
			<a href="/policy/m/privacy2019.do">- 2019. 1. 29 ~ 2020. 3. 18 적용</a>
			<a href="/policy/m/privacy2017.do">- 2017. 6. 20 ~ 2019. 1. 28 적용 </a>
			<a href="/policy/m/privacy2016.do">- 2016. 5. 23 ~ 2017. 6. 19 적용</a>
