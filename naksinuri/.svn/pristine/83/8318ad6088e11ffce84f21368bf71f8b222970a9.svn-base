<%@page import="egovframework.com.cmm.web.EgovWebEditorPath"%>
<%@page import="org.springframework.beans.factory.annotation.Autowired"%>
<%@page import="org.springframework.stereotype.Service"%>
<%@page import="egovframework.com.cmm.service.EgovFileMngUtil"%>
...
<%
	String result="";
	EgovWebEditorPath aa = new EgovWebEditorPath();
	result=aa.getse2Path();
    ...
    if (cnt == 0) {
        ...
        //파일 기본경로
        String dftFilePath =result;//result;//request.getServletContext().getRealPath("/upload");// 
        //파일 기본경로 _ 상세경로
