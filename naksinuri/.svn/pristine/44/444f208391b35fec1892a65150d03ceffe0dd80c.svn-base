 ...
 * 테이블명 : 
 */
public class EduCenterMainVO extends EduVO {
	...
	private String EDU_APLY_NTCN_SNDNG_YN;//enum('Y','N') NULL교육 신청 알림 발송 여부	
	...
	private String HMBR_SN;//사용자 이수내역번호
	private String HMBR_LRNNG_PRGRS;//커리큘럼 내 수강 이수율 합
	private String CRS_GRP_CD_NM;//교육과정그룹명
	
	private String eventClassName;
	private String basic_select;//게시판 검색
	private String search_word;//게시판 검색어
	...
	public String getCRS_GRP_CD_NM() {
		return CRS_GRP_CD_NM;
	}
	public void setCRS_GRP_CD_NM(String cRS_GRP_CD_NM) {
		CRS_GRP_CD_NM = cRS_GRP_CD_NM;
	}
	...
	public String getHMBR_LRNNG_PRGRS() {
		return HMBR_LRNNG_PRGRS;
	}
	public void setHMBR_LRNNG_PRGRS(String hMBR_LRNNG_PRGRS) {
		HMBR_LRNNG_PRGRS = hMBR_LRNNG_PRGRS;
	}
	...
	public String getBasic_select() {
		return basic_select;
	}
	public void setBasic_select(String basic_select) {
		this.basic_select = basic_select;
	}
