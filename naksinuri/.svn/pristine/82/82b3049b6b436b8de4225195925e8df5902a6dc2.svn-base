 ...
 */
public class EduCurriculumVO extends EduDefaultVO {
	...
	private String EXTRL_INSTT_RLS_CD;//외부기관 공개여부 교육기관 코드 목록(CAT_INS_SN)
	...
	private String CRS_YEAR;//교육년도
	private String CRS_MONTH;//교육월
	private String EDU_APLY_NTCN_SNDNG_YN; //교육알림신청여부
	...
	private String CRS_END_DT_GE_NOW;//crs_end_dt >= now() 현재보다 크거나 같음
	private String CRS_GRP_NM;//교육과정그룹(코드)명
	private String EDU_APLY_NTCN_SNDNG_YN_CHK;//교육 신청 알림 발송 여부 사용유무체크박스	
	
	
	public String getEXTRL_INSTT_RLS_CD() {
		return EXTRL_INSTT_RLS_CD;
	}
	public void setEXTRL_INSTT_RLS_CD(String eXTRL_INSTT_RLS_CD) {
	...
	public String getCRS_END_DT_GE_NOW() {
		return CRS_END_DT_GE_NOW;
	}
	public void setCRS_END_DT_GE_NOW(String cRS_END_DT_GE_NOW) {
		CRS_END_DT_GE_NOW = cRS_END_DT_GE_NOW;
	}
	...
	public String getCRS_MONTH() {
		return CRS_MONTH;
	}
	public void setCRS_MONTH(String cRS_MONTH) {
		CRS_MONTH = cRS_MONTH;
	}
	public String getEDU_APLY_NTCN_SNDNG_YN() {
		return EDU_APLY_NTCN_SNDNG_YN;
	}
	public void setEDU_APLY_NTCN_SNDNG_YN(String eDU_APLY_NTCN_SNDNG_YN) {
		EDU_APLY_NTCN_SNDNG_YN = eDU_APLY_NTCN_SNDNG_YN;
	}
	public String getEDU_APLY_NTCN_SNDNG_YN_CHK() {
		return EDU_APLY_NTCN_SNDNG_YN_CHK;
	}
	public void setEDU_APLY_NTCN_SNDNG_YN_CHK(String eDU_APLY_NTCN_SNDNG_YN_CHK) {
		EDU_APLY_NTCN_SNDNG_YN_CHK = eDU_APLY_NTCN_SNDNG_YN_CHK;
	}
