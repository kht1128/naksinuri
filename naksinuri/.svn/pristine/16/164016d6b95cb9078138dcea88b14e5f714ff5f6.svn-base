	...
	<div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
		<div class="panel">
      		<div class="panel-body">
        		<div class="brand">
        			<h1 class="blue-600">낚시누리 관리자</h1>
          			<!-- <img class="brand-img" src="/common/img/logo_edu.png" alt="...">  -->
          			<h2 class="brand-text font-size-18 mt-30 mb-10">(개발사전용)</h2>
        		</div>
        		<form method="post" action="/adm/member/login_pass_act.do">
					...
					<div class="form-group clearfix">
						<!-- 
		          		<div class="checkbox-custom checkbox-inline checkbox-primary float-left">
			            	...
			            	<label for="inputCheckbox">자동로그인</label>
						</div>
						-->
		         		<!-- <a class="float-right" href="javascript:alert('준비중');">비밀번호 찾기</a> -->
		       		</div>
		       		<button type="submit" class="btn btn-primary btn-block">로그인</button>
				</form>
				<!-- <p>계정이 없는 경우 다음을 클릭하세요. <a href="javascript:alert('준비중');">회원가입</a></p> -->
      		</div>
    	</div>
