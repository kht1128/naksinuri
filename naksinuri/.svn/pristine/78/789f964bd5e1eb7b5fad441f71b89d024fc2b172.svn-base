					...
					<dl>
						...
						<dd>
							<ul class="choicebox floats">
								...
								<li><input type="radio" id="riverfishing" name="fishing_type" value="riverfishing" OnClick="window.location.href='/info/m/riverfishing.do';" checked />
			...
			<section id="shipform" class="basic_formbox mgt30">
				...
				<div class="writeBox">
					...
					<dl>
						<dt>오시는 길</dt>
						<dd class="multi_input">
							<input type="text" class="naksi_input readonly" name="co_addr2_1" value="${info.co_addr2_1}" id="busipostcode" readonly size="7" /><a href="#;" class="basicBox bgGray zipcodeBox" onclick="busiaddress()">주소검색</a>
					...
					<dl>
						<dt>사업장 소개</dt>
						<dd>
							<textarea placeholder="예) 친절하고 깨끗한 환경, 확실한 조과 보장" class="basic_textarea" name="co_intro" id="co_intro" cols="60" >${info.co_intro }</textarea>	
						</dd>
					</dl>
					<dl>
						<dt>대표 이미지</dt>
