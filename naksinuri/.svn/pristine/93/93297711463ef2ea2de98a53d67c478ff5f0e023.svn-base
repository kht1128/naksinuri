		...
		<div id="content">			
			...
			<div class="btn_area textcenter">
				...
				<c:if test="${info.evn_trash eq '1' }">
					<a href="/admin/sosig/event/trash.do" class="btn_size2 btn_bordergray">취소</a>
				</c:if>
				
				
				<!-- 일반게시판에서 글 조회,수정 -->
				<c:if test="${info.evn_trash eq '0' && info.evn_no ne null}">
					<a href="/admin/sosig/event/list.do" class="btn_size2 btn_bordergray">취소</a>
