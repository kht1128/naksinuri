...
<style>
	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
				...
				<table class="basic_tbl mgt10px">
						...
						<tbody>
							<tr>
								...
								<td class="word-spacing">낚시관리 및 육성법 제47조, 같은 법 시행규칙 제25조, 낚시전문교육 및 교육기관 지정에 관한 고시 제7조, 정보주체 동의</td>
				...
				<table class="basic_tbl mgt10px">
						...
						<tbody>
							<tr>
								<td class="text-center">1</td>
								<td class="text-center">낚시전문교육<br>교육대상자 명단</td>
								<td class="underBold word-spacing">수강인구분(낚시터업자, 낚시어선업자, 선원), 성명, 생년월일, 주소, 휴대전화번호, 해기사면허 유무, 허가(등록)·신고 시·군·구명</td>
								<td class="underBold">전화번호, 이메일, 허가(등록)신고증 번호, 어선번호(낚시<br>어선에 한함), 낚시터(낚시어선) 명칭, 유효기간</td>
							</tr>
						</tbody>
					</table>
			</div>
			...
			<a href="/policy/privacy2019.do">- 2019. 1. 29 ~ 2020. 3. 18 적용</a>
			<a href="/policy/privacy2017.do">- 2017. 6. 20 ~ 2019. 1. 28 적용 </a>
			<a href="/policy/privacy2016.do">- 2016. 5. 23 ~ 2017. 6. 19 적용</a>
