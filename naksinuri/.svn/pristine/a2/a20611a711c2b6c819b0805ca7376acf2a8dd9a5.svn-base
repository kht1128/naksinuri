...
<c:set var="pageName" value="binding" />
...
<%@include file="../admin_leftTab.jsp"%>
	...
	<div id="container">
		...
		<div id="content">			
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 채비필수묶음법 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
