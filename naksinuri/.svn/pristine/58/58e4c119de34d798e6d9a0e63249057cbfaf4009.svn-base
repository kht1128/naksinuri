...
<div id="wrapper">
	...
	<form:form commandName="listform" id="listform" name="listform" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="mid" id="mid" value="${item.mid }"/>
					...
					<table class="t_list">
						...
						<c:forEach var="item" items="${select_list}">
							<tr>
								...
								<td class="textcenter"><a target="_blank" href="${item.link}">${fn:substring(item.regdate,0,16)}</a></td>		
				...
				<div align="right"><a href="#;" onclick="fncGroupListDelete()" class="btn_size1 btn_violet">삭제</a><a href="/admin/sosig/news/view.do" class="btn_size1 btn_violet">글쓰기</a></div>
				<!-- 페이지 { -->
				<div id="pagenation">
