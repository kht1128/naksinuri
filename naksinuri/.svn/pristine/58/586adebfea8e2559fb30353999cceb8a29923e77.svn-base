...
<div id="customerSound" class="content">
   ...
   <section id="writeForm" class="write_box">
		<div class="agree_text">
			낚시대회에 신청할때 입력하신 이름/전화번호 항목으로 조회해주세요.</br></br>
		</div>
		<dl>
			<dt><span class="colorRed">*</span> 이름</dt>
			<dd><input type="text" class="write_input w70" placeholder="이름을 입력해주세요." id="mbr_name" name="mbr_name" title="이름"/></dd>
		</dl>
		<dl>
			<dt><span class="colorRed">*</span> 전화번호</dt>
			<dd><input type="text" class="write_input w70" placeholder="전화번호를 입력해주세요. (ex:010-1234-1234)" id="mbr_hp" name="mbr_hp" title="전화번호(ex:010-1234-1234)"/></dd>
		</dl>
...
function search_congress(){
		...
		form.action = "/sosig/congress/mbrsearch.do";
		form.submit();
}
