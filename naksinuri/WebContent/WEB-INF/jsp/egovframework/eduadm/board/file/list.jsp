...
<div class="page">
	<div class="page-header">
		...
		<div class="page-header-actions">
			<a class="append-rows btn btn-primary btn-outline" href="/eduadm/board/file/write.do" >
...
function fnView(bdsn) {
    ...
    document.viewForm.action = "<c:url value='/eduadm/board/file/view.do'/>";
    document.viewForm.submit();
}
function fnSearch(){
	document.listForm.pageIndex.value = 1;
	document.listForm.action = "<c:url value='/eduadm/board/file/list.do'/>";
    document.listForm.submit();
}
function fnDelete(bdsn,bdst) {
	...
	alertify.confirm(alert_message, function(){ 
		document.viewForm.BD_SN.value = bdsn;
	    document.viewForm.action = "<c:url value='/eduadm/board/file/delete_act.do'/>";
	    document.viewForm.submit();	 
	});
}	
function fnModify(bdsn) {
	document.viewForm.BD_SN.value = bdsn;
    document.viewForm.action = "<c:url value='/eduadm/board/file/modify.do'/>";
    document.viewForm.submit();
}
</script>
