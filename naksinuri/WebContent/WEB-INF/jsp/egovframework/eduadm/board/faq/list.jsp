...
<div class="page">
	<div class="page-header">
		...
		<div class="page-header-actions">
			<a class="append-rows btn btn-primary btn-outline" href="/eduadm/board/faq/write.do" >
						...
						<tbody>
							...
							<tr>
	                 			...
	                 			<td class="text-left" >
									...
									<a href="javascript:fnView('${item.BD_SN}');"><c:out value="${item.BD_TITLE}"/></a>
								</td>
...
function fnView(bdsn) {
    ...
    document.viewForm.action = "<c:url value='/eduadm/board/faq/view.do'/>";
    document.viewForm.submit();
}
function fnSearch(){
	document.listForm.pageIndex.value = 1;
	document.listForm.action = "<c:url value='/eduadm/board/faq/list.do'/>";
    document.listForm.submit();
}
