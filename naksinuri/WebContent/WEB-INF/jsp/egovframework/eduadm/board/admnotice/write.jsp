...
<form:form commandName="eduBoardVO" id="listForm" name="listForm" method="post" enctype="multipart/form-data" onsubmit="return frm_submit()" 
	action="/eduadm/board/admnotice/write_act.do"> 
			...
			<div class="panel-body">
				...
				<div class="form-group row">
					...
					<c:forEach var="item_category" items="${list_position_cd}">
						<div class="checkbox-custom mr-10">
							<input type="checkbox" id="BD_TRGT_CD_${item_category.CD_ID}" name="BD_TRGT_CD" value="${item_category.CD_ID}" >
				...
				<div class="form-group row">
					<label class="col-md-2 form-control-label" >제목</label>
		           	<div class="col-md-10 pl-0">
		            	<input type="text" class="form-control" id="BD_TITLE" name="BD_TITLE" placeholder="제목을 입력하세요." autocomplete="off" value="" required>
					</div>
				</div>	
				<div class="form-group row">
				...
				<div class="form-group row">
					<label class="col-md-2 form-control-label" for="CRS_NM">내용</label>
		           	<div class="col-md-10 pl-0">
		            	<textarea name="BD_CONT" id="BD_CONT" rows="10" cols="100" style="/*width:766px; height:412px;*/ display:none;"></textarea>
					</div>
				</div>
