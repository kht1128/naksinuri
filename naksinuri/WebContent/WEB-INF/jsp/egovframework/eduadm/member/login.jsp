		...
		<div class="panel">
      		<div class="panel-body">
        		...
        		<form id="smsAuthForm" name="smsAuthForm" onsubmit="return go_step();" method="post">
					...
					<input type="hidden" name="admin_page_name" value="eduadm">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<div class="form-group clearfix">
								...
								-->
				         		<!-- <a class="float-right" href="javascript:alert('준비중');">ㅂㅁ 찾기</a> -->
				       		</div>
	...
	<script>
		...
		function go_step() {
			...
			if(isCheck){
				...
				frm.action = '/eduadm/member/login_act.do';
			}
