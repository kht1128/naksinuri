...
<form:form commandName="eduMemberVO" id="listForm2" name="listForm2" class="modal-content form-horizontal" method="post">
	...
	<input type="hidden" name="searchYear" value="${eduMemberVO.searchYear}" />
	...
	<div class="modal-body">
		<div class="input-group col-md-12 float-right mb-10">
			<input type="text" class="form-control mr-10" name="searchKeyword" placeholder="이름,생년월일,연락처,아이디,선박명 또는 상호명를 입력하세요." autocomplete="off">
...
function fn_egov_link_page_2(pageNo){
	...
	form.action = '';
   	$.ajax({
		type:"POST",
		url :"/eduadm/member/edu/ajaxlist.do",
...
$("#btn_submit").click(function() {
	$.ajax({
		type:"POST",
		url :"/eduadm/member/edu/write_act.do",
		data:$('#listForm2').serialize(),
		dataType: "json",
		contentType: "application/x-www-form-urlencoded;charset=UTF-8",//"application/json;charset=UTF-8",
		async: true,
