...
<div class="content respon3">
	<section id="writeForm" class="write_box">
		<h2>교육 서비스 제공을 위한 개인정보 수집·이용 동의서</h2>
		<div class="agree_box">
			...
			<table class="basic_tbl mt-10">
				...
				<thead>
					<tr class="table-cell-blind"><td></td></tr>
				</thead>
				<tbody>
					<tr>
			...
			<ul class="floats">
				<li class="fr">
					<div class="agree_yesorno mt-30">
						<span class="txt mr-10">(필수) 개인정보 수집 및 이용에</span>
					...
					<div class="agree_yesorno mt-10">
						<span class="txt mr-10">(선택) 개인정보 수집 및 이용에</span>
...
$(".clk_btn_act").click(function() {
	...
	form.action = "/educenter/trnng/write.do";
