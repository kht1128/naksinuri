...
<form:form commandName="mbrHpChngVO" id="listForm" name="listForm" method="post" >
	...
	<div class="content respon3">
		...
		<section id="writeForm" class="write_box mt-30">
			<h2>본인명의 휴대폰 미소지자 정보 변경 신청서</h2>
			<p class="dottedbox font-weight-bold mb-30 emphasis">이름,생년월일,연락처는 로그인(본인인증)시 본인여부 확인에 사용되므로 불일치시 로그인이 불가능 할 수 있으므로 주의하여 입력해주시기 바랍니다.</p>
			<p class="dottedbox">이메일 naksinuri@fipa.or.kr / 팩스 0505-742-1004 / 문의 ☎1833-7139</p>
			<div class="agree_box">
				<h3 class="mt-30 under-blue wx140">교육 이수자</h3>
				<table class="basic_tbl mt-10">
					...
					<tbody>		
						<tr>
							...
							<td><input type="text" class="basic_input w100 " name="MHC_EDU_NM" value="" placeholder="성명을 입력해주세요." data-fail-message="성명은 필수 입력정보입니다." autocomplete="off" required ></td>
							<th class="text-center">생년월일 <span class="red-600">*</span></th>
							<td><input type="text" class="basic_input w100 mbr-birth-input-pattern" name="MHC_EDU_BRTHDY" value="" placeholder="예)19190301" data-fail-message="생년월일은 필수 입력정보입니다.<br>19190301 형식으로 8자리를 입력해주세요." autocomplete="off" required ></td>
						</tr>
						<!-- <tr>
			...
			<div class="agree_box">
				<h3 class="mt-30 wx140 under-blue">핸드폰 명의자</h3>
				<table class="basic_tbl mt-10">
					<caption>본인명의 휴대폰 미소지자 정보 변경 신청서</caption>
					<colgroup>
						<col width="140" />
					...
					<tbody>		
						<tr>
							<th class="text-center">성 명 <span class="red-600">*</span></th>
							<td><input type="text" class="basic_input w100 " name="MHC_NM" value="${name}" placeholder="성명을 입력해주세요." data-fail-message="성함은 필수 입력정보입니다." autocomplete="off" readonly ></td>
							<th class="text-center">생년월일 <span class="red-600">*</span></th>
							<td><input type="text" class="basic_input w100 mbr-birth-input-pattern" name="MHC_BRTHDY" value="${birthDay}" placeholder="예)19190301" data-fail-message="생년월일은 필수 입력정보입니다.<br>19190301 형식으로 8자리를 입력해주세요." autocomplete="off" readonly ></td>
						</tr>
						<!-- <tr>
							<th class="text-center">주 소 <span class="red-600">*</span></th>
							<td colspan="3">
			...
			<div class="agree_yesorno dottedbox mt-20 text-center">
				...
				<input type="radio" name="approval" id="approvalY" value="Y" ><label for="approvalY"><span></span>동의함</label>
				<input type="radio" name="approval" id="approvalN" value="N" ><label for="approvalN"><span></span>동의하지 않음</label>
			</div>
			<div id="btnArea">
