					 ...
					 <ul>
					 	<c:forEach var="item" items="${list_banner_center}">
							<li class="text-center">
								<a class="display-inline-block" <c:if test="${not empty item.PP_LINK_URL}">
									...
									<c:when test="${isMobile eq 'Y'}">
										<img src='/cmm/fms/getImage.do?atchFileId=${item.PP_FILE}&fileSn=0' alt="${item.PP_CONT}" style="height: 100%;"/>
									</c:when>
									<c:otherwise>
				...
				<div class="inner">
					<div class="sponsor-slide">
						<div class="control_btn">
							<!-- 이전 버튼 -->
							<div class="swiper-button-prev swiper-button-prev03">이전</div>
							<!-- 다음 버튼  -->
							<div class="swiper-button-next swiper-button-next03" onblur="$('.sponsor-slide .swiper-slide-active a').focus();">다음</div>
						</div>
							
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide"><a href="http://www.mof.go.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink01.png" alt="해양수산부" /></a></div>
				                <div class="swiper-slide"><a href="https://www.fipa.or.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink02.png" alt="KFPA 한국어촌어항공단" /></a></div>
				                <div class="swiper-slide"><a href="https://www.facebook.com/FIPAkor" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink10.png" alt="한국어촌어항공단 공식 페이스북" /></a></div>
				                <div class="swiper-slide"><a href="http://www.sealife.go.kr" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink09.png" alt="귀어귀촌" /></a></div>
				                <div class="swiper-slide"><a href="http://www.kff.or.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink03.png" alt="KFF 한국낚시연합" /></a></div>
				                <div class="swiper-slide"><a href="http://www.nifs.go.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink04.png" alt="국립수산과학원" /></a></div>
				                <div class="swiper-slide"><a href="http://www.fira.or.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink05.png" alt="FIRA 한국수산자원관리공단" /></a></div>
				                <div class="swiper-slide"><a href="http://www.kst.or.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink06.png" alt="선박안전기술공단" /></a></div>
				                <div class="swiper-slide"><a href="https://www.komsa.or.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink11.png" alt="한국해양교튱안전공단" /></a></div>
				                <div class="swiper-slide"><a href="http://www.khoa.go.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink07.png" alt="국립해양조사원 KHOA" /></a></div>
				                <div class="swiper-slide"><a href="http://www.koreafca.kr/" target="_blank" tabindex="0" onfocus="caroufredsel_pause();"><img src="/naksinuri_original/common_main/img/ico_mainGoLink08.png" alt="한국낚시업중앙회" /></a></div>
							</div>
						</div>
					</div>
				</div>
