...
<div id="fishjobList" class="content respon2">
	...
	<section id="writeForm" class="write_box">
		<!-- <h2></h2> -->
		<div class="agree_box">
			<p class="dottedbox text-center">
			현재 <span class="font-weight-bold red-600">${fn:length(list)}</span> 건 이상의 회원정보가 발견되어<br>접속이 거부되었습니다.<br><br>고객센터(1833-7139)로 연락해주시기 바랍니다.
			</p>
		</div>
	</section>
	
	<section id="webzineList" class="list_box">
		<div class="board_list overflow-x">
			<table class="list_tbl" style="width:1000px;">
