  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <header>
        ...
        <p style="font-size:1.5em;">해당 서비스는 로그인이 필요합니다.</p>
      </header>  
      <p class="error-advise" >아래 버튼을 클릭하여 이동해주세요.</p>
      <a class="btn btn-info btn-round" href="/educenter/m/index.do">로그인</a>
      <%--<a class="btn btn-info btn-round" href="/member/joincheck.do">회원가입</a> --%>
