...
<form:form commandName="eduCprBplcVO" id="listForm" name="listForm" method="post" >
	...
	<div class="content respon3">
		<section id="writeForm" class="write_box">
			<h2 class="font-weight-bold text-title mt-10"><c:out value="${DTL_NAME}"/> 법인사업장<br>교육책임자 지정 확인서</h2>
			<div class="agree_box">
				<h3 class="under-blue wx140">법인대표자</h3>
					...
					<tbody>		
						<tr>
							<td>
								...
								<input type="text" class="basic_input w100 " name="ECB_CPR_NM" id="ECB_CPR_NM" value="" placeholder="성함을 입력해주세요." data-fail-message="성함은 필수 입력정보입니다." autocomplete="off" required>
							</td>
						</tr>
						<tr>
							<td>
								<h4>생 년 월 일 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 mbr-birth-input-pattern" name="ECB_CPR_BRTHDY" id="ECB_CPR_BRTHDY" value="" placeholder="예)19190301" data-fail-message="생년월일은 필수 입력정보입니다.<br>19190301 형식으로 8자리를 입력해주세요." autocomplete="off" required >
							</td>
						</tr>
						<tr>
							<td>
								<h4>${SIGNGU } <span class="red-600">*</span></h4>
						...
						<tr>
							<td>
								<h4>${REG_NUMBER } <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 reg-num-cd-input-pattern" name="ECB_REG_NUM_CD" id="ECB_REG_NUM_CD" value="" placeholder="${REG_NUMBER }를 입력해주세요." data-fail-message="${REG_NUMBER }는 필수 입력정보입니다." autocomplete="off" maxlength="10" required >
							</td>
						</tr>
						<tr>
							<td>
								<h4><c:out value="${DTL_NAME}"/>명 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 " name="ECB_CPR_DTL_NM" id="ECB_CPR_DTL_NM" value="" placeholder="<c:out value="${DTL_NAME}"/>명을 입력해주세요." data-fail-message="<c:out value="${DTL_NAME}"/>명은 필수 입력정보입니다." autocomplete="off" required>
							</td>
						</tr>
						<tr>
							<td>
								<h4>휴대전화번호<span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 mbr-hp-input-pattern" name="ECB_CPR_HP" id="ECB_CPR_HP" value="" placeholder="예)01012345678" data-fail-message="연락처는 필수 입력정보입니다." autocomplete="off" required >
							</td>
						</tr>
						<tr>
							<td>
				...
				<h3 class="mt-10 under-blue wx140">교육책임자</h3>
				<table class="basic_tbl mt-10">
					...
					<tbody>
						<tr>
							<td>
								<h4>성 명 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 " name="ECB_EDU_NM" id="ECB_EDU_NM" value="" placeholder="성명을 입력해주세요." data-fail-message="성함은 필수 입력정보입니다." autocomplete="off" required>
							</td>
						</tr>
						<tr>
							<td>
								<h4>생 년 월 일 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 mbr-birth-input-pattern" name="ECB_EDU_BRTHDY" id="ECB_EDU_BRTHDY" value="" placeholder="예)19190301" data-fail-message="생년월일은 필수 입력정보입니다.<br>19190301 형식으로 8자리를 입력해주세요." autocomplete="off" required >
							</td>
						</tr>
						<tr>
							<td>
								<h4>직 책 · 자 격 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 " name="ECB_EDU_POSIT" id="ECB_EDU_POSIT" value="" placeholder="직책 · 자격을 입력해주세요." data-fail-message="성함은 필수 입력정보입니다." autocomplete="off" required>
							</td>
						</tr>
						<tr>
							<td>
								<h4>휴대전화번호 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100 mbr-hp-input-pattern" name="ECB_EDU_HP" id="ECB_EDU_HP" value="" placeholder="예)01012345678" data-fail-message="연락처는 필수 입력정보입니다." autocomplete="off" required >
							</td>
						</tr>
						<tr>
							<td>
								<h4>주 소 <span class="red-600">*</span></h4>
								<input type="text" class="basic_input w100px mr-5 wp40" id="ECB_EDU_ZIP" name="ECB_EDU_ZIP" id="ECB_EDU_ZIP" placeholder="우편번호" readonly />
