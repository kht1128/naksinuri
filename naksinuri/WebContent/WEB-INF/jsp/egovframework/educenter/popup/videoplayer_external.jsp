...
<%@include file="../../naksinuri_original/naksinuri/layout/head.sub.jsp"%>
...
function savePoint() {
	...
	alert("구간1:"+videoCurTimeSec);
	/* 
	alert(videoCurTimeSec);
	
	if(videoNowSeeTime < videoCurTimeSec) {
