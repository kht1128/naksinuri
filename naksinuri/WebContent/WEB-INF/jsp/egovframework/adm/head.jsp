	...
	<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega bg-blue-600 navbar-inverse" role="navigation">
    	<div class="navbar-header" >
      		<div class="navbar-brand navbar-brand-center site-gridmenu-toggle" style="width:100%; text-align: center; ">
          		...
          		<span class="navbar-brand-text hidden-xs-down"> 시스템 설정</span>
        	</div>
      	...
      	<div class="navbar-container container-fluid">
        	...
        	<div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
    	  		...
    	  		<ul class="nav navbar-toolbar">
	          		...
	          		<li class="nav-item dropdown">
		         		...
		         		<div class="dropdown-menu" role="menu">
		         			<a class="dropdown-item admin-act-nav-link" href="javascript:void(0);" data-linkurl="/adm/index.do"><b class="yellow-800">시스템 설정</b> 페이지 이동</a>
		         			<%-- <a class="dropdown-item admin-act-nav-link" href="javascript:void(0);" data-linkurl="/adm/index.do"><b class="yellow-800">낚시누리</b> 관리자 페이지 이동</a> --%>
		           			...
		           			<a class="dropdown-item admin-act-nav-link" href="javascript:void(0);" data-linkurl="/expoadm/index.do"><b class="yellow-800">박람회</b> 관리자 페이지 이동</a>
		           			 -->
		           		</div>
		       		</li>
          		</ul>
          		...
          		<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          			<!-- 
             		<li class="nav-item"><a class="nav-link" href="javascript:go_home();"><i class="icon wb-home yellow-600" aria-hidden="true"></i> 교육센터 홈페이지로 이동 <span class="sr-only">(current)</span></a></li>
             		-->
            		<li class="nav-item dropdown">
