...
<c:forEach var="fileVO" items="${fileList}" varStatus="status">
	...
	<c:choose>
		<c:when test="${depthName eq 'promotion' and pageName eq 'info'}">
			<source src="/upload/${fileVO.streFileNm}" type="video/mp4"></source>
			<source src="/upload/${fileVO.streFileNm}" type="video/webm"></source>
			<source src="/upload/${fileVO.streFileNm}" type="video/ogg"></source>
		</c:when>
		<c:otherwise>
...
<c:forEach var="fileVO" items="${fileList}" varStatus="status">
	<video id="my-player" class="video-js" style="width:100%;">
