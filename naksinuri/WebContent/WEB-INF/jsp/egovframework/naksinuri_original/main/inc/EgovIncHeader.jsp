...
<h1><a href="/naksinuri_original/cmm/main/mainPage.do">템플릿 로고</a>
</h1>
<a href="<c:url value='/naksinuri_original/EgovPageLink.do?link=main/sample_menu/Intro'/>" target="_blank"><img width="20" height="20" src="<c:url value='/images/question.jpg'/>" alt="메뉴구성 설명" title="메뉴구성 설명"></a>
...
<script type="text/javascript">
    ...
    function goMenuPage(menuNo){
        ...
        document.menuListForm.action = "<c:url value='/naksinuri_original/EgovPageLink.do'/>";
...
<form name="menuListForm" action ="/naksinuri_original/sym/mnu/mpm/EgovMenuListSelect.do" method="post">
