...
<script type="text/javascript" src="<c:url value="/naksinuri_original/js/EgovMainMenu.js"/>"></script>
...
function fn_MovePage(nodeNum) {
    ...
    document.menuListForm.action = "/naksinuri_original"+nodeValues[5];
...
<div class="left_wrap">
	<div class="top"><img src="/naksinuri_original/images/title_image/img_menu_title01.gif" alt="서브메뉴" /></div>             
	<div class="nav_style" >
		<script type="text/javascript">
         var Tree = new Array;
