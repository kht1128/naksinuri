	...
	<div id="fishjobList" class="content respon2">
		...
		<section id="webzineList" class="list_box">
			<div class="list_searchbox">
				...
				<input type="text" class="basic_input" title="옵션선택(제목+내용,제목,내용)"/>
				...
				<ul class="floats">
					...
					<li>
						...
						<a href="view.do" class="subject">
							<em>황어</em>
							<span class="txt">민물과 바다 오가는 알고 보면 '귀족고기' 표준명 : 황어 학 명 : Tribolodonhakonesis 영 명 : Big scaled redfin 일 명 : ウグイ(ugui) 속 명 : 항어ㆍ밀황어 잉어과에 속하는 황어는 유일하게 하천에...... </span>
						</a>
