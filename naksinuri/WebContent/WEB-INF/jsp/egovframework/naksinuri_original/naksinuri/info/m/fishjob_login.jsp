...
<article id="fishinfoRegister" class="content">
	<section class="fir_login">
		...
		<div class="fir_login_area">
			...
			<div class="btnArea">
				<a href="/info/m/boatfishing.do" class="btns submitBtn bgBlue">신규등록 바로가기</a>
			</div>
		</div>
	</section>
</article>
...
<div id="search_result_box" class="imsimodal_shadow">
	<div class="imsimodal">
		...
		<div class="btnArea">
			<a href="/info/m/boatfishing.do" class="btns submitBtn bgBlue">신규등록 바로가기</a>
			<a href="javascript:location.href='/info/m/fishjob/login.do';" class="btns submitBtn bgBlue mgt10">나가기</a>
		</div>
		<a href="javascript:location.href='/info/m/fishjob/login.do';" class="closebtn"><img src="/naksinuri_original/common_main/img/ico_close.png" /></a>
	</div>
</div>
<form name="veiw_go" id="veiw_go" action ="<c:url value='/info/fishjob/m/fish_viewS.do'/>" method="post">
...
<div id="wrapper">
	...
	<div id="container" class="respon">
		<section id="login" class="content">
			<div class="btnArea" style="margin-top:-0.5%;padding-bottom:20px">
				<a href="/info/m/boatfishing.do" class="submitBtn bgBlue">신규등록 바로가기</a>
			</div>
		</section>
	</div>
	...
	<div id="search_result_box" style="display: none; width: 500px; height: 400px; ">
		<div style="border: solid 3px red; padding: 50px;">
			...
			<a href="/info/m/boatfishing.do" class="submitBtn bgBlue">신규등록 바로가기</a>
			<br><br>
			<a href="javascript:location.href='/info/m/fishjob/login.do';" class="submitBtn bgBlue">나가기</a>
