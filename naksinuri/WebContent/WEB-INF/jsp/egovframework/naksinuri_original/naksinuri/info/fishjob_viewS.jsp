...
<form:form commandName="supform" id="supform" method="post" enctype="multipart/form-data" >
	...
	<div id="fishjobView" class="content respon2">	
		...
		<center><div style="font-size: 48px; font-weight: bold; letter-spacing: -0.5pt; font-family: NanumSquare;">이미 등록된 정보</div></center>
		...
		<section id="mapArea">
			<div class="tabArea">
				<ul class="floats">
					<li class="on"><a href="#;" onclick="locate()" id="locate" title="오시는길"><i class="fa fa-map-marker" aria-hidden="true" title="오시는길"></i> 오시는길</a></li>
					<li><a href="#;" onclick="public_festival()" id="public_festival" title="축제/행사"><i class="fa fa-flag" aria-hidden="true" title="축제/행사"></i> 축제/행사</a></li>
					<li><a href="#;" onclick="public_trv()" id="public_trv" title="관광지"><i class="fa fa-map" aria-hidden="true" title="관광지"></i> 관광지</a></li>
					<li><a href="#;" onclick="public_food()" id="public_food" title="음식점"><i class="fa fa-cutlery" aria-hidden="true" title="음식점"></i> 음식점</a></li>
					<li><a href="#;" onclick="public_shop()" id="public_shop" title="쇼핑"><i class="fa fa-shopping-bag" aria-hidden="true" title="쇼핑"></i> 쇼핑</a></li>
				</ul>
			</div>
			<div id="map_wrap">
		...
		<div id="btnArea">
			...
			<a href="/info/fishjob/login.do" class="btn_review btn_blue">취소</a>
		</div>
</form:form>
...
function go_modify() {
	...
	$.ajax({
		url: "/info/fishjob/fish_modify_check.do",
		type: "POST",
