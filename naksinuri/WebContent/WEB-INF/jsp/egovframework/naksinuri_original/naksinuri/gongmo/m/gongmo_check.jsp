...
<%@include file="../../layout/m/head.jsp"%>
	...
	<div id="customerSound" class="content respon3">
		...
		<div class="tabArea tab2"> <!-- 탭이 3개면 class="tabArea tab3" 4개면 뭐겠냐 -->
			<ul class="floats">
				<li class="on"><a href="/gongmo/gongmo/m/check.do">공모전 접수/신청</a></li>
				<li><a href="/gongmo/gongmo/m/search.do" >접수 확인</a></li>
			</ul>
		</div>
		...
		<section id="writeForm" class="write_box">				
			...
			<div class="owner_box">
				...
				<dl>
					<dd>
						<select class="write_input w100" onchange="change_gongmo(this);" name="bo_sn">		
...
function submitContents() {
	...
	$("#imform").attr("action", "/gongmo/gongmo/m/mbrwrite.do");
	$("#imform").submit();
