		...
		<article id="boardView" class="floats">
			<section id="viewContent">
				...
				<div class="content">
					...
					--%>
					<%--
					<div class="set_btn_center mgt30px">
						...
						<form method="post" name="replform" id="replform" onsubmit="return replsubmit();">
							...
							<div class="reply_write">
								...
								<div class="reply_input">
									<input type="number" class="reply_input" name="eco_gongmo_hp" id="eco_gongmo_hp" placeholder="휴대폰번호" /> (숫자만 입력해주세요)
								</div>
								<div class="reply_input">
									<input type="text" class="reply_input wp100" name="eco_gongmo_url" id="eco_gongmo_url" placeholder="업로드한 URL" />
								</div>
