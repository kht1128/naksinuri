	...
	<c:set var="pagesize" value="${event_total/pageUnit}"/>
		...
		<div id="fishjobList" class="content respon2">
			...
			<div class="tabArea tab3">
				<ul class="floats">
					<li><a href="/gongmo/event/m/list.do" id="event" >진행중인 이벤트</a></li>
					<li class="on"><a href="/gongmo/endevent/m/list.do" id="endevent">종료된 이벤트</a></li>
...
if(pageName =='event' && gallery_list == 'gallery'){
	...
	function fnSelectInfs(pageIndex) {
		...
		$("#frm").attr("action", "/gongmo/endevent/m/list.do");
		$("#frm").submit();
	...
	function view2(evn_no){
		...
		form.action="/gongmo/event/m/view.do";
		form.submit();
	};	
