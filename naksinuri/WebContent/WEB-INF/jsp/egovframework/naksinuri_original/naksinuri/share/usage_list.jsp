				...
				<ul class="floats">
					...
					<li>
						...
						<a href="view.do" class="subject">
							<em>제10장 자연현상과 붕어낚시</em>
							<span class="txt">비와 붕어낚시 비가 수계에 미치는 영향 근본적으로 하늘에서 내리는 비는 많은 산소를 내포하고 있어서 수중의 산소용존량을 높여준다. 따라서 수중의 모든 생물들은 활성을 갖게되며, 붕어 또한 활발한 움직임을.....</span>
						</a>
