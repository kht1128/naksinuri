...
<c:set var="pageName" value="gongmo" />
...
<input type="hidden" name="bo_type" value="gongmo" />
<input type="hidden" name="bo_sn" id="bo_sn" value="${info.bo_sn}" />
<input type="hidden" name="returnUrl" value="<c:url value='/admin/gongmo/gongmo/board_findCorp.do'/>"/>
...
<input type="hidden" name="is_entry_y" id="is_entry_y" value="1" />
				...
				<div class="padding_box">
					<table class="t_write" id="ftable">
						...
						<tbody>	
							...
							<tr>
								<th>주최</th>
								<td><input type="text" name="organizer" id="organizer" class="frm_input" value="${info.organizer}"  /></td>
							</tr>	
							<tr>
								<th>주관</th>
								<td><input type="text" name="host" id="host" class="frm_input" value="${info.host}"  /></td>
							</tr>
							<tr>
								<th>담당자</th>
							...
							<tr class="is_entry_check" style="display:none">
								<th>참가신청 안내문구</th>
								<td>
									<textarea name="entry_notice" id="entry_notice"  class="frm_input"  style="width:100%;height:80px;border:1px solid #cdcdcd" autocomplete="off">${info.entry_notice}</textarea>
								</td>
							</tr>												
							<tr>
								<th>암호설정</th>
