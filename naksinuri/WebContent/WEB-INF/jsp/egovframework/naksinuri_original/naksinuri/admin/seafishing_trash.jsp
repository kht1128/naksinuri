...
function fnSelectInfs(pageIndex) {
	...
	$("#frm").attr("action", "${pageContext.request.contextPath}/admin/info/seafishing/trash.do");
	$("#frm").submit();
...
<input type="hidden" name="fishing_type" id="fishing_type" value="seafishing" />
...
<div id="wrapper">
	...
	<div id="container">
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 바다낚시 휴지통 <div class="trash_box"><%@include file="trash_selectBox.jsp" %></div></h1>
					...
					<div class="listtop floats">
						<div class="totalnum">총 <b>${admin_total}</b>건</div>
							<div class="listnum" align="right">
								...
								<br>
								<a href="/admin/info/seafishing/trash.do" class="btn_size1 btn_violet">최신순</a>
								<a href="/admin/info/sealatest/trash.do" class="btn_size1 btn_violet">등록순</a>
								<a href="/admin/info/seaKor/trash.do" class="btn_size1 btn_violet">한글순</a>
							</div>
					</div>
					<table class="t_list">
						<colgroup>
...
function fncGroupListDelete() {
	if(fncManageChecked()) {
	    if(confirm("삭제하시겠습니까?")) {
            document.listform.action = "/info/admin/deletes.do";
...
function fncGroupListRestore() {
	if(fncManageChecked()) {
	    if(confirm("삭제하시겠습니까?")) {
            document.listform.action = "/info/admin/restores.do";
            document.listform.submit();
	    }
	}
}
