		...
		<div class="date_choice row">
			<div class="col-lg-6">
				<div class="btn-group btn-group-sm" role="group" aria-label="...">
					<button type="button" class="btn btn-primary" onclick="get_osday()">최근 1일</button>
					<button type="button" class="btn btn-default" onclick="get_osweek()">7일</button>
					<button type="button" class="btn btn-default" onclick="get_osmonth()">30일</button>
					<button type="button" class="btn btn-default" onclick="type_myself()">직접입력</button>
				</div>
			</div>
			<form id="frm">
				<div class="col-lg-6">
					<input type="text" id="start_dt" name="start_dt" readonly class="date_input" value="${starts}"/> ~ <input type="text" id="end_dt" name="end_dt" readonly class="date_input" value="${ends}"/> <button type="button" class="btn btn-default btn-sm" onclick="getOS_myself()">조회</button>
				</div>
			</form>
		</div>
...
$(document).ready(function(){
	...
	$.ajax({
		type:"GET",
		url :'/admin/getUser_OSInfoday.do',
		dataType: 'json',
...
function get_osmonth(){
	document.location.href="/admin/static/invitos/listm.do";
}
