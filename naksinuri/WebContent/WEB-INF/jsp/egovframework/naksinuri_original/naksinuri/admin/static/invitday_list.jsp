			...
			<div class="date_choice row">
				<div class="col-lg-6">
					<div class="btn-group btn-group-sm" role="group" aria-label="...">
						<button type="button" id="static_day" name="static_day" class="btn btn-primary" onclick="statistics_day();" >최근 1일</button>
				...
				<div class="col-lg-6">
					<input type="text" id="start_dt" name="start_dt" class="date_input" /> ~ <input type="text" id="end_dt" name="end_dt" class="date_input" /> <button type="button" onclick="invitInfo_myself()" class="btn btn-default btn-sm">조회</button>
				</div>
			</div>
			<div id="search_form">	
...
function statistics_week(){
	document.location.href="/admin/static/invit/list.do";
}	
