...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">			
						...
						<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 낚시명예감시원 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>

			<section id="table-list">
				<!-- 탭 영역 { -->
				<div id="tabarea">
					<%@include file="../trash_selectBox.jsp" %>
					<ul class="floats">
					</ul>
				</div>
				<!-- } 탭 영역 -->
