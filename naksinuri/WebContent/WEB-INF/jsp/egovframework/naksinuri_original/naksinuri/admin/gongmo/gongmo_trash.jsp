...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 진행중인 공모전 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
						...
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/gongmo/endtrash.do" class="cateend">종료된 공모전</a></li>
