	...
	<!-- 사이트통계 { -->
		<article id="siteCondition">
			...
			<div class="date_choice row">
				...
				<form id="frm">
					<div class="col-lg-6">
						<input type="text" id="start_dt" name="start_dt" class="date_input" value="${start_dt}"/> ~ <input type="text" id="end_dt" name="end_dt" class="date_input" value="${end_dt}"/> <button type="button" onclick="statistics_myself()" class="btn btn-default btn-sm">조회</button>
					</div>
				</form>
			</div>
...
function statistics_month(){
	document.location.href="/admin/static/likepagemonth/list.do";
}
