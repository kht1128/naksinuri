...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 진행중인 캠페인 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>

			<section id="table-list">
				<!-- 탭 영역 { -->
				<div id="tabarea">
					<ul class="floats">
						<li><a href="#;"  class="on">진행중인 캠페인</a></li>
						<li><a href="/admin/promotion/campaign/endtrash.do">종료된 캠페인</a></li>
					</ul>
				</div>
				<!-- } 탭 영역 -->
