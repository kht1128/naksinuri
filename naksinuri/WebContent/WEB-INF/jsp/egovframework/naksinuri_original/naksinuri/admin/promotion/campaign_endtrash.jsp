...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">			
			...
			<h1 class="bigTit"><i class="fa fa-trash" aria-hidden="true"></i> 종료된 캠페인 휴지통 <div class="trash_box"><%@include file="../trash_selectBox.jsp" %></div></h1>
			...
			<section id="table-list">
				...
				<div id="tabarea">
					...
					<ul class="floats">
						<li><a href="/admin/promotion/campaign/trash.do">진행중인 캠페인</a></li>
						<li><a href="#;" class="on">종료된 캠페인</a></li>
					</ul>
				</div>
				<!-- } 탭 영역 -->
					...
					<table class="t_list">
						...
						<c:forEach var="item" items="${select_list}">
							<tr>
								...
								<td class="textcenter"><a href="#;">${item.bo_start_dt}<br>${item.bo_end_dt}</a></td>	
...
function fncGroupListDelete() {
	if(fncManageChecked()) {
	    if(confirm("삭제하시겠습니까?")) {
            document.listform.action = "./delete_endlist.do";
