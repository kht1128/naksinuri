...
<c:set var="pageName" value="usage" />
...
<input type="hidden" name="bo_type" value="usage" />
									...
									<c:when test="${bmimg ne null }">
										...
										<c:out value="${bmimg.orignl_file_nm}"/>&nbsp;<c:out value="[${bmimg.file_size} Byte]"/>
											...
											<img class="cursor" alt="파일 삭제" src="<c:url value='/naksinuri_original/images/btn/bu5_close.gif'/>"
							       			...
							       			width="19" height="19" onClick="fn_egov_getImage('<c:out value="${bmimg.bo_main_img}"/>','<c:out value="${bmimg.file_sn}"/>');" style="margin-left:10px"/>
							       			<img class="cursor" alt="파일 다운" src="<c:url value='/naksinuri_original/common_main/img/icon_file.gif'/>" 
							       			width="19" height="19" onClick="fn_egov_downFile('<c:out value="${bmimg.bo_main_img}"/>','<c:out value="${bmimg.file_sn}"/>');" />
										</td>
									</c:when>
									<c:otherwise>
												...
												<li>
													<c:out value="${bsimg.orignl_file_nm}"/>&nbsp;<c:out value="[${bsimg.file_size} Byte]"/>
														<img class="cursor" alt="파일 삭제" src="<c:url value='/naksinuri_original/images/btn/bu5_close.gif'/>"
										       			...
										       			<img class="cursor" alt="파일 보기" src="<c:url value='/naksinuri_original/images/egovframework/com/ency.gif'/>" 
										       			width="19" height="19" onClick="fn_egov_getImage('<c:out value="${bsimg.bo_sub_img}"/>','<c:out value="${bsimg.file_sn}"/>');" style="margin-left:10px"/>
										       			<img class="cursor" alt="파일 다운" src="<c:url value='/naksinuri_original/common_main/img/icon_file.gif'/>" 
										       			width="19" height="19" onClick="fn_egov_downFile('<c:out value="${bsimg.bo_sub_img}"/>','<c:out value="${bsimg.file_sn}"/>');" />
												</li>
											</ul>
										</td>
										</c:when>
									...
									<tr>
										...
										<td>
											<c:out value="${item.orignl_file_nm}"/>&nbsp;<c:out value="[${item.file_size} Byte]"/>
												<img class="cursor" alt="파일 삭제" src="<c:url value='/naksinuri_original/images/btn/bu5_close.gif'/>" width="19" height="18" onClick="fn_egov_deleteFile('<c:out value="${item.bo_atch_file}"/>','<c:out value="${item.file_sn}"/>');" />
												
												<img class="cursor" alt="파일 보기" src="<c:url value='/naksinuri_original/images/egovframework/com/ency.gif'/>" 
								       			width="19" height="19" onClick="fn_egov_getImage('<c:out value="${item.bo_atch_file}"/>','<c:out value="${item.file_sn}"/>');" style="margin-left:10px"/>
								       			<img class="cursor" alt="파일 다운" src="<c:url value='/naksinuri_original/common_main/img/icon_file.gif'/>" 
								       			width="19" height="19" onClick="fn_egov_downFile('<c:out value="${item.bo_atch_file}"/>','<c:out value="${item.file_sn}"/>');" />
										</td>
									</tr>
								</c:forEach>
									<tr id="file_0">
