...
function fnSelectInfs(pageIndex) {
	...
	$("#frm").attr("action", "${pageContext.request.contextPath}/info/admin/seafishing.do");
	$("#frm").submit();
	...
	<div id="container">
		<div id="content">			
			...
			<form:form commandName="seaform" id="seaform" name="listform" method="post" enctype="multipart/form-data" >
					...
					<div class="listtop floats">
						<div class="totalnum">총 <b>${admin_total}</b>건</div>
							<div class="listnum" align="right">
								...
								<br>
								<a href="/info/admin/seafishing.do" class="btn_size1 btn_violet">최신순</a>
								<a href="/info/admin/sealatest.do" class="btn_size1 btn_violet">등록순</a>
								<a href="/info/admin/seaKor.do" class="btn_size1 btn_violet">한글순</a>
							</div>
					</div>
					<table class="t_list">
						<colgroup>
				...
				<div align="right"><a href="#;" onclick="fncGroupListDelete()" class="btn_size1 btn_violet">삭제</a><a href="/info/admin/write_sea.do" class="btn_size1 btn_violet">글쓰기</a></div>
				<!-- 페이지 { -->
				<div id="pagenation">
...
function fncGroupListDelete() {
	if(fncManageChecked()) {
	    if(confirm("삭제하시겠습니까?")) {
            document.listform.action = "/info/admin/gotrash_sealist.do";
