		...
		<div class="date_choice row">
			<div class="col-lg-6">
				<div class="btn-group btn-group-sm" role="group" aria-label="...">
					...
					<button type="button" class="btn btn-primary" onclick="get_osweek()">7일</button>
			...
			<form id="frm">
				<div class="col-lg-6">
					<input type="text" readonly id="start_dt" name="start_dt" class="date_input" value="${starts}"/> ~ <input type="text" id="end_dt" readonly name="end_dt" class="date_input" value="${ends}"/> <button type="button" class="btn btn-default btn-sm" onclick="getOS_myself()">조회</button>
				</div>
			</form>
		</div>
