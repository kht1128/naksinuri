...
<input type="hidden" name="bo_type" value="gosi" />
...
<%-- <input type="hidden" id="bo_sido" value="${info.bo_sido}" /> --%>
				...
				<div class="padding_box">
					<table class="t_write" id="ftable">
						...
						<tbody>							
							...
							<tr>
								<th>지역</th>
								<td><select name="bo_sido" id="bo_sido" >
									<option value="">지역 선택</option>
									<option value="서울" <c:if test="${info.bo_sido eq '서울' }">selected</c:if>>서울</option>
									<option value="세종" <c:if test="${info.bo_sido eq '세종' }">selected</c:if>>세종</option>
									<option value="인천" <c:if test="${info.bo_sido eq '인천' }">selected</c:if>>인천</option>
									<option value="대전" <c:if test="${info.bo_sido eq '대전' }">selected</c:if>>대전</option>
									<option value="광주" <c:if test="${info.bo_sido eq '광주' }">selected</c:if>>광주</option>	
									<option value="대구" <c:if test="${info.bo_sido eq '대구' }">selected</c:if>>대구</option>
									<option value="울산" <c:if test="${info.bo_sido eq '울산' }">selected</c:if>>울산</option>
									<option value="부산" <c:if test="${info.bo_sido eq '부산' }">selected</c:if>>부산</option>
									<option value="경기" <c:if test="${info.bo_sido eq '경기' }">selected</c:if>>경기</option>
									<option value="강원" <c:if test="${info.bo_sido eq '강원' }">selected</c:if>>강원</option>
									<option value="충북" <c:if test="${info.bo_sido eq '충북' }">selected</c:if>>충북</option>
									<option value="충남" <c:if test="${info.bo_sido eq '충남' }">selected</c:if>>충남</option>
									<option value="전북" <c:if test="${info.bo_sido eq '전북' }">selected</c:if>>전북</option>
									<option value="전남" <c:if test="${info.bo_sido eq '전남' }">selected</c:if>>전남</option>
									<option value="경북" <c:if test="${info.bo_sido eq '경북' }">selected</c:if>>경북</option>
									<option value="경남" <c:if test="${info.bo_sido eq '경남' }">selected</c:if>>경남</option>
									<option value="제주" <c:if test="${info.bo_sido eq '제주' }">selected</c:if>>제주</option>
								</select></td>
