	...
	<div id="container">
		<div id="content">			
			...
			<section id="table-list">
				...
				<div id="tabarea">
					<ul class="floats">
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/event/list.do">목록조회</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/yevent/list.do" >진행중인 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/nevent/list.do" >종료된 이벤트</a></li>
						<li><a href="${pageContext.request.contextPath}/admin/gongmo/aevent/list.do"  class="on">공지사항 & 당첨자발표</a></li>
<!-- 						<li><a href="#;">상세내용</a></li> -->
					</ul>
				</div>
				<!-- } 탭 영역 -->
					...
					<table class="t_search">
						...
						<tbody>
							...
							<tr>
								<th>검색</th>
								<td colspan="5">
									<select class="frm_select" style="width:100px" name="searchType" title="검색조건선택">
							
										<option value="evn_subject">제목</option>
										<option value="evn_name">글쓴이</option>
		
									</select>
									<input type="text" class="frm_input" size="70" name="searchText" title="검색어 입력"/> 
	...
	<form:form commandName="listform" id="listform" name="listform" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="evn_no" id="evn_no" value="${item.evn_no }"/>
				...
				<div align="right"><a href="#;" onclick="fncGroupListDelete()" class="btn_size1 btn_violet">삭제</a><a href="/admin/gongmo/aevent/view.do" class="btn_size1 btn_violet">글쓰기</a></div>
				<!-- 페이지 { -->
				<div id="pagenation">
...
function view2(evn_no){
	...
	form.action="/admin/gongmo/event/aevent_findCorp.do";
	form.submit();
};
