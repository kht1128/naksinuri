...
<div>
	...
	<div id="customerSound" class="content respon3">
		<section id="writeForm" class="write_box">
			...
			<dl>
				...
				<c:choose>
					<c:when test="${not empty co_nm}">
						<dd><input type="text" size="100" class="write_input" placeholder="제목을 입력해주세요." value="${co_nm}"/></dd>
					</c:when>
					<c:otherwise>
						<dd><input type="text" size="100" class="write_input" placeholder="제목을 입력해주세요." id="voc_subject" name="voc_subject" value="${info.voc_subject }"/></dd>
					</c:otherwise>
				</c:choose>
			</dl>	
			<c:choose>
			...
			<input type="hidden" name="voc_issecret" id="voc_issecret" value="0">
			<!-- <dl>
...
<!-- 			</dl> -->
			...
			<div id="btnArea">
				<ul class="floats">
					...
					<a href="/policy/customer_sound_list.do" class="btn_prev btn_white">취소</a></li>
				</ul>
			</div>
		</section>
	</div>
...
//웹접근성대응 
oEditors.getById["voc_content"].exec("UPDATE_CONTENTS_FIELD", [ ]);
