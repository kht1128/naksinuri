		...
		<section id="privacyCon">
			...
			<div class="pvc_infoList">
			    <ul>
			        ...
			        <li><a style="width: auto; height: auto; background-color: initial; color: initial; text-align:left; margin:0; margin-bottom:20px;" href="#step11" class="icon14"><span>가명정보 처리에 관한 사항</span></a></li>
			...
			<div id="step03" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_06.png" alt="3조" />제3조(처리하는 개인정보 항목)</h3>
			...
			<div id="step04" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_14.png" alt="4조" />제4조(개인정보 영향평가 수행 결과)</h3>
			...
			<div id="step05" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_03.png" alt="5조" />제5조(개인정보의 제3자 제공)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="adong" /></h3>
			...
			<div id="step06" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_04.png" alt="6조" />제6조(개인정보처리의 위탁)</h3>
			...
			<div id="step08" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_05.png" alt="8조" />제8조(정보주체와 법정대리인의 권리·의무 및 행사방법)</h3>
			...
			<div id="step09" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_08.png" alt="9조" />제9조(개인정보의 안전성 확보조치)<img style="width: 103px; height: 130px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang02.png" alt="fiparang2" /></h3>
			...
			<div id="step10" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_09.png" alt="10조" />제10조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h3>
   			...
   			<div id="step11" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_14.png" alt="11조" />제11조(가명정보 처리에 관한 사항)</h3>
			...
			<div id="step12" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_10.png" alt="12조" />제12조(개인정보 보호책임자 및 담당자)</h3>
			...
			<div id="step13" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_11.png" alt="13조" />제13조(개인정보 열람청구)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="adong" /></h3>
			...
			<div id="step14" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_12.png" alt="14조" />제14조(권익침해 구제방법)</h3>
			...
			<div id="step15" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_14.png" alt="7조" />제15조(개인정보 관리수준진단 결과)</h3>
				
				<p class="dottedbox">① 한국어촌어항공단은 정보주체의 개인정보를 안전하게 관리하기 위해 「개인정보 보호법」 제11조에 따라 매년 개인정보보호위원회에서 실시하는 "공공기관 개인정보 관리수준진단"을 받고 있습니다.</p>
				<p class="dottedbox">② 한국어촌어항공단은 2022년도 개인정보 관리수준진단 평가에서  <span class="bold">'S'</span> 등급을 획득하였습니다.<br>  ※ S등급: 90점 이상, A등급: 80점 이상, B등급: 70점 이상, C등급: 60점 이상, D등급: 60점 이하</p>
				
			</div>
			
			<div id="step16" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_13.png" alt="13조" />제16조(개인정보 처리방침 변경)</h3>
				<p class="dottedbox">① 이 개인정보 처리방침은 <span class="bold">2023. 07. 26.</span>부터   적용됩니다.</p>
				<!-- <p class="dottedbox">② 개인정보처리방침의 변경내용은 다음과 같습니다.</p>
				<src="href=''"></src> -->
				<p class="dottedbox">② 이전의 개인정보 처리방침은 아래에서 확인하실수 있습니다.</p>
			</div>
			<a href="/policy/privacy20230726.do" class="bold">- 2022. 06. 30 ~ 2023. 07. 26 적용</a>
			<a href="/policy/privacy20230726.do" class="bold">- 2022. 06. 30 ~ 2023. 07. 26 적용</a>
