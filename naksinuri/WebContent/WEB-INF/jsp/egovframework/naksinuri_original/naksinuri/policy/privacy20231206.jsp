	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
			...
			<div id="step05" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_03.png" alt="5조" />제5조(개인정보의 제3자 제공)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="" /></h3>
			...
			<div id="step09" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_08.png" alt="9조" />제9조(개인정보의 안전성 확보조치)<img style="width: 103px; height: 130px; margin-left:5px" src="/naksinuri_original/images/policy/ico_fiparang02.png" alt="" /></h3>
			...
			<div id="step10" class="con">
   			...
   			<div id="step11" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_15.png" alt="11조" />제11조(가명정보 처리에 관한 사항)</h3>
			...
			<div id="step13" class="con">
				<h3><img style="width: 80px; height: 80px;" src="/naksinuri_original/images/policy/pvc_11.png" alt="13조" />제13조(개인정보 열람청구)<img style="width: 112px; height: 143px; margin-left:5px" src="/naksinuri_original/images/policy/adong3.png" alt="" /></h3>
			...
			<div id="step16" class="con">
				...
				<p class="dottedbox">① 이 개인정보 처리방침은 <span class="bold">2023. 08. 29.</span>부터   적용됩니다.</p>
				<p class="dottedbox">② 개인정보처리방침의 변경내용은 다음과 같습니다.</p>
				<h3><img style="width: 900px; height: 400px;"img src="/naksinuri_original/images/policy/test-03.png" alt="policy_img" /></h3>
