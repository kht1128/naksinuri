		...
		<section id="privacyCon">
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							<tr>
								...
								<td>(주)와토시스</td>
								<td>042-471-7290</td>
								<td>낚시정보종합포털<span class="underBold-red"> 내부시스템 운영<br>지원 및 시스템 유지보수</span></td>
								<td>O</td>
							</tr>
							<tr>
								<td>2</td>
			...
			<div class="con">
				...
				<div class="downloadbox mgt30 text-center">
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','4')" class="">[개인정보보호법 시행규칙 별지 제8호]<br>개인정보 열람 요구서</a>
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','3')" class="">[개인정보보호법 시행규칙 별지 제11호]<br>위임장</a>
				</div>			
			</div>
			<div class="con">
			...
			<div class="con">
				...
				<p class="dottedbox">① 이 개인정보 처리방침은 2021. 08. 31. 부터   적용됩니다.</p>
