	...
	<div id="privacy" class="content respon3">
		<section id="privacyCon">
			...
			<div class="con">
				...
				<p class="dottedbox">
					① “낚시누리”는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보<br>보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다. 
				</p>
				...
				<table class="basic_tbl mgt10px">
						...
						<tbody>
							<tr>
								...
								<td>낚시관리 및 육성법 제47조, 같은 법 시행규칙 제25조, 낚시전문교육 및 교육기관 지정에 관한 고시 제7조, 정보주체 동의</td>
								<td class="underBold">낚시전문교육 교육대상자의 신원 확인, 교육사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보, 교육 이수증 발급</td>
							</tr>
						</tbody>
					</table>
				<p class="dottedbox mgt10px"> 상세한 “낚시누리”의 개인정보파일 등록사항 공개는 행정안전부 개인정보보호 종합지원 포털 (www.privacy.go.kr) → 민원마당 → 개인정보열람등 요구 → 개인정보파일 목록검색 메뉴를 활용해주시기 바랍니다.   
				</p>
			</div>
				...
				<table class="basic_tbl mgt10px text-center">
						...
						<tbody>
							<tr>
								...
								<td>(주)와토시스</td>
								<td>042-471-7290</td>
								<td>낚시전문교육<span class="underBold-red"> 내부시스템 운영<br>지원 및 시스템 유지보수</span></td>
								<td>O</td>
							</tr>
							<tr>
								<td>2</td>
								<td>군산대학교산학협력단</td>
								<td>063-469-7571</td>
								<td rowspan="2">낚시전문교육 업무 수행을 위한<br><span class="underBold-red">교육대상자 정보 처리</span></td>
								<td>O</td>
							</tr>
							<tr>
								<td>3</td>
			...
			<div class="con">
				...
				<p class="dottedbox">③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장 및 신분을 확인할 수 있는 증명서(주민등록증 등)를 제출하셔야 합니다.</p>
				...
				<div class="downloadbox mgt30 text-center">
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','4')" class="">[별지 제8호]<br>개인정보 열람 요구서</a>
					<a href="#;" onclick="fn_egov_downFile('FILE_000000000000000','3')" class="">[별지 제11호]<br>위임장</a>
				</div>			
			</div>
			<div class="con">
				...
				<table class="basic_tbl mgt10">
						...
						<tbody>
							<tr>
								<td class="text-center">1</td>
								<td class="text-center">낚시전문교육<br>교육대상자 명단</td>
								<td class="underBold">수강인구분(낚시터업자, 낚시어선업자, 선원), 성명, 생년월일, 주소, 휴대전화번호, 해기사면허 유무, 허가(등록)·신고 시·군·구명</td>
								<td class="underBold">전화번호, 이메일, 허가(등록)신고증 번호, 어선번호(낚시어선에 한함), 낚시터(낚시어선) 명칭, 유효기간</td>
							</tr>
						</tbody>
					</table>
			</div>
				...
				<table class="basic_tbl mgt10 text-center">
						...
						<tbody>
							<tr>
								...
								<td>정종민</td>
								<td>02-6098-0842</td>
								<td>jjm@fipa.or.kr</td>
								<td rowspan="3">02-6098-0830</td>
							</tr>
							<tr>
								<td>어장산업팀</td>
								<td>조현진</td>
								<td>02-6098-0843</td>
								<td>chj051@fipa.or.kr</td>
							</tr>
							<tr>
								<td>어장산업팀</td>
								<td>허은희</td>
								<td>02-6098-0844</td>
								<td>heh124@fipa.or.kr</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="con">
				...
				<p class="dottedbox">① 이 개인정보 처리방침은 2020. 06. 29. 부터   적용됩니다.</p>
