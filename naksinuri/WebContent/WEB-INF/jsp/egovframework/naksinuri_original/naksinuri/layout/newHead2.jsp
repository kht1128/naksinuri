	...
	<header id="header">
		...
		<div id="page_bar">
			<ul>
				...
				<li><a href="/educenter/index.do">교육포털</a></li>
			</ul>
		</div>
		<!-- ##start## new_top ##### -->
		<div id="new_top">
			<div class="Grp">
				...
				<div class="Grp_left">
					<!-- mini bnr start -->
					<div class="mini_bnr">
					<img src="/naksinuri_original/common_main/img/main/egov_logo.png">
						<ul>
							<li><a href="#none">이 누리집은 대한민국 공식 전자정부 누리집입니다.</a></li>
						</ul>
					</div>
					<!-- mini bnr end -->
				</div>
					...
					<ul id="gnb_1dul" class="gnb_1dul_m6 gnb1ul"> <!-- 데이터트리 수정진행 floats 제거-->
						...
						<li class="gnb1li gnb_1dli ">
							...
							<ul class="gnb_2dul">
								...
								<li class="gnb_2dli"><a href="/educenter/trnngoffline/fshhpList.do" class="gnb_2da">현장교육 신청(낚시어선)</a></li>
