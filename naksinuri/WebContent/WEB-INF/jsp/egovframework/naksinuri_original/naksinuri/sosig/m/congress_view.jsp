			...
			<section id="viewContent">
				<div class="viewTit">
					...
					<ul class="eyes_heart floats">
						...
						<li><a href="#;"><em><i class="fa fa-heart" aria-hidden="true"></i></em>${info.bo_like }</a></li>
							...
							<div class="info">
								<c:if test="${entry_start < nowDate && entry_end > nowDate}">
									<div id="btnArea" class="noupline mgb30 pdt0" >
							 			<a href="#;" class="btn_blue" onclick="write_form(${info.bo_sn})"><i class="fa fa-user-plus" aria-hidden="true"></i> 참가신청</a>
							 			<a href="/sosig/congress/m/mbrcheck.do" class="btn_gray" ><i class="fa fa-user-plus" aria-hidden="true"></i> 접수내역확인</a>
							 		</div>
								</c:if>
								<div class="wrp_lst">
				...
				<div class="content">
					<%-- <c:if test="${info.is_entry_y != '1'}"> --%>
						<c:choose>
							...
							<c:otherwise>
								<%-- 모바일은 포스터가 없을 경우 일부러 노출할 필요가 없음.
