...
<script type="text/javascript" src="<c:url value='/naksinuri_original/js/EgovZipPopup.js' />" ></script>
...
<div id="wrap"> 
    <!-- header start -->
    <div id="subheader"><c:import url="/naksinuri_original/sym/mms/EgovMainMenuHead.do" /></div>  
    <!-- //header end -->
    <!--  타이틀 이미지 시작 -->
    <div id="title_img_div"><img src="/naksinuri_original/images/title_image/img_title06.gif" alt="" /></div>
    <!--  //타이틀 이미지 끝 -->
    <div id="bodywrap">
        <div id="leftmenu_div"><c:import url="/naksinuri_original/sym/mms/EgovMainMenuLeft.do" /></div>
        <div id="middle_content">
            ...
            <form:form commandName="mberManageVO" action="/naksinuri_original/uss/umt/cmm/EgovMberSbscrb.do" name="mberManageVO"  method="post" >
                    ...
                    <table summary="일반회원 가입정보">
			            <tr> 
			                <td class="td_width">일반회원아이디
			                    <img src="/naksinuri_original/images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/>
			                </td>
			                <td class="td_content">
			                    ...
			                    <a href="#LINK" onclick="javascript:fnIdCheck(); return false;">
			                        <img alt="중복아이디 검색" align="middle" src="<c:url value='/naksinuri_original/images/img_search.gif'/>">(중복아이디 검색)
			                    </a>
			                ...
			                <td class="td_content">
			                    ...
			                    <form:hidden path="zip" />
			                        <a href="#LINK" onclick="javascript:fn_egov_ZipSearch(document.mberManageVO, document.mberManageVO.zip, document.mberManageVO.zip_view, document.mberManageVO.adres);">
			                            <img alt="우편번호 검색" src="<c:url value='/naksinuri_original/images/img_search.gif'/>">(우편번호 검색)
			                        </a>
