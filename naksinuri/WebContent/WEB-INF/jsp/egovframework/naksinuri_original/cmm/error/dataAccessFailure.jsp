        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><img src="<c:url value='/naksinuri_original/images/egovframework/com/cmm/er_logo.jpg' />" width="379" height="57" alt="er_logo" /></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td width="74" rowspan="2" align="center"><img src="<c:url value='/naksinuri_original/images/egovframework/com/cmm/danger.jpg' />" width="74" height="74" alt="danger" /></td>
              ...
              <tr>
                <td align="center"><a href="#LINK" onClick="fncGoAfterErrorPage();"><img src="<c:url value='/naksinuri_original/images/egovframework/com/cmm/go_history.jpg' />" width="90" height="29" alt="go_history" /></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>
    	...
    	<div id="__layout">
            <div class="__nuxt-error-page">
                <div class="error">
                	...
                	<div class="title">데이터 처리 중 오류가 발생하였습니다.</div>
