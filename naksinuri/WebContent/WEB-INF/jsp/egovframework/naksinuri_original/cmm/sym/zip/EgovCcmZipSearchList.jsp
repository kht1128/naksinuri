...
<title>우편번호 찾기</title>
<script type="text/javascript" src="<c:url value='/naksinuri_original/js/showModalDialogCallee.js'/>" ></script>
...
<table style="width:550px" cellpadding="8" class="table-search" border="0">
 <tr>
  <td style="width:35%" class="title_left">
		<img src="<c:url value='/naksinuri_original/images/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목"/> 우편번호 찾기
  </td>
  ...
  <th style="width:5%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td><img src="<c:url value='/naksinuri_original/images/bu2_left.gif'/>" alt="조회" width="8" height="20" /></td>
      ...
      <td><img src="<c:url value='/naksinuri_original/images/bu2_right.gif'/>" alt="조회" width="8" height="20" /></td>
      <td width="10"></td>
    </tr>
   </table>
  </th>  
