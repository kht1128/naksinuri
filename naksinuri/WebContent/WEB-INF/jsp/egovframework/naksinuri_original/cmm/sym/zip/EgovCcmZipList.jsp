...
<link href="/naksinuri_original/css/common.css" rel="stylesheet" type="text/css" >
...
<div id="wrap">
    <!-- header 시작 -->
    <div id="header"><c:import url="/naksinuri_original/EgovPageLink.do?link=main/inc/EgovIncHeader" /></div>
    <div id="topnavi"><c:import url="/naksinuri_original/sym/mms/EgovMainMenuHead.do" /></div>        
    <!-- //header 끝 --> 
    <!-- container 시작 -->
    <div id="container">
        <!-- 좌측메뉴 시작 -->
        <div id="leftmenu"><c:import url="/naksinuri_original/sym/mms/EgovMainMenuLeft.do" /></div>
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div id="content">
                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="#noscript" onclick="fn_egov_search_Zip(); return false;"><img src="/naksinuri_original/images/img_search.gif" alt="search" />조회 </a>
