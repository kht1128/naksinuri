		...
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="panel mb-20">
					...
					<select
						class="form-control selectpicker_manual-${CUSTOM_UNIQ_KEY} inline_15"
						data-style="btn-outline btn-default" name="HCALL_SELECT"
						id="hcall_select_type">
						<option value="1">이전모드(2023.12.01이전)</option>
						<option value="">개편모드(2023.12.01적용)</option>
					</select>	          		
...
<!-- End Page -->
    ...
    $(".clk_search_btn_analysis").click(function() {
    	fn_analysis_staff_report2();
    	fn_analysis_ivr_report2();
    	fn_analysis_ivr_compare_report2();
    	fn_analysis_cvpl_report2();
    }); 
    function fn_analysis_staff_report2(){
    	...
    	$.ajax({
    		type:"POST",
    		url :"/cti/analysis/staff/report_ajax2.do",
    ...
    function fn_analysis_ivr_report2(){
    	var form = document.getElementById('listForm_analysis');
    	form.action = '';
    	$.ajax({
    		type:"POST",
    		url :"/cti/analysis/ivr/report_ajax2.do",
    		data:$('#listForm_analysis').serialize(),
    		dataType: 'html',//"json",
    		contentType: "application/x-www-form-urlencoded;charset=UTF-8",//"application/json;charset=UTF-8",
    		async: true,
    ...
    function fn_analysis_ivr_compare_report2(){
    	var form = document.getElementById('listForm_analysis');
    	form.action = '';
    	$.ajax({
    		type:"POST",
    		url :"/cti/analysis/ivr_compare/report_ajax2.do",
    		data:$('#listForm_analysis').serialize(),
    		dataType: 'html',//"json",
    		contentType: "application/x-www-form-urlencoded;charset=UTF-8",//"application/json;charset=UTF-8",
    		async: true,
    ...
    function fn_analysis_cvpl_report2(){
    	var form = document.getElementById('listForm_analysis');
    	form.action = '';
    	$.ajax({
    		type:"POST",
    		url :"/cti/analysis/cvpl/report_ajax2.do",
    		data:$('#listForm_analysis').serialize(),
    		dataType: 'html',//"json",
    		contentType: "application/x-www-form-urlencoded;charset=UTF-8",//"application/json;charset=UTF-8",
    		async: true,
		...
		$("#hcall_select_type").on('change', function() {

			let val = $("#hcall_select_type >option:selected").attr('value');

			
			if(val==''){
				

				location.href = '/cti/analysis/index.do';		
