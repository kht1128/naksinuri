...
onmessage = function(event){
	...
	else if(valID == "Login")
	{
		...
		head.ID = "TELPER_AGTSTATE_CTI_LOGIN";
		head.KIND = "Request";
	...
	else if(valID == "Logout")
	{
		...
		head.SOURCE = "SoftPhone";
		head.DEST = "TlpCtiPClt";
		head.ID = "TELPER_AGTSTATE_CTI_LOGOUT";
		head.KIND = "Request";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Avail")
	{
		...
		head.SOURCE = "SoftPhone";
		head.DEST = "TlpCtiPClt";
		head.ID = "TELPER_AGTSTATE_CTI_AVAIL";
		head.KIND = "Request";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail0")
	{
		...
		head.SOURCE = "SoftPhone";
		head.DEST = "TlpCtiPClt";
		head.ID = "TELPER_AGTSTATE_CTI_UNAVAIL";
		head.KIND = "Request";
		
		var body = new Object();
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_0";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail1")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_1";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail2")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_2";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail3")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_3";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail4")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_4";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail5")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_5";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail6")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_6";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail7")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_7";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail8")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_8";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Unavail9")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_UNAVAIL_9";					
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work0")
	{
		...
		head.SOURCE = "SoftPhone";
		head.DEST = "TlpCtiPClt";
		head.ID = "TELPER_AGTSTATE_CTI_WORK";
		head.KIND = "Request";
		
		var body = new Object();
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_0";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work1")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_1";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work2")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_2";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work3")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_3";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work4")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_4";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work5")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_5";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work6")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_6";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work7")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_7";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work8")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_8";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "Work9")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_9";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "WorkACW")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_ACW";
...
//		$('#log').append('<li>' + "[" + dt + "] " + 'sended: <span class="badge">' + jsonStr + '</span></li>');
	...
	else if(valID == "WorkCTF")
	{
		...
		body.TELNO = telno;
		body.CTI_ID = ctiid;				
		body.SUBSTATE = "TELPER_AGTSTATE_CTI_WORK_CTF";
...
function postButtonStatus(bConnect, bDisconnect, 
	...
	if(bGroupPickup)				message.GROUPPICKUP = "on";					else		message.GROUPPICKUP = "off";
...
function UpdateButtonStatus(objJsonMsg)	{
	...
	if(objJsonMsg.HEAD.ID == "TLPCTI_EVENT_ID_POPUP")
		return;
	...
	if( objStatus.AGENT_STATUS != "TELPER_AGTSTATE_CTI_AVAIL")
	{
		bLogOut = true;
	}
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_0" )
	{
		bAvail = true;
		bUnavail1 = true;
		bUnavail2 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_1" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail2 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_2" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_3" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_4" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_5" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_6" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_7" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_8" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_UNAVAIL_9" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_0" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_1" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_2" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_3" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_4" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_5" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_6" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_7" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_8" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_9" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_ACW" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	else if( objStatus.AGENT_STATUS == "TELPER_AGTSTATE_CTI_WORK_CTF" )
	{
		bAvail = true;
		bUnavail0 = true;
		bUnavail1 = true;
	...
	if( strCallCount == "1")
	{
		...
		if( strStatus0 == "TLPCTI_EVENT_ID_RINGING" || strStatus0 == "TLPCTI_EVENT_ID_RINGING_FORWARD" || strStatus0 == "TLPCTI_EVENT_ID_XFERRED" )
		{
			bDisconnectCall = false;
			bAnswerCall = true;	
		}
		else if( strStatus0 == "TLPCTI_EVENT_ID_CONNECTED" || strStatus0 == "TLPCTI_EVENT_ID_CONNECTED_PICKUP" )
		{
		...
		else if( strStatus0 == "TLPCTI_EVENT_ID_HOLD" )
		{
			bDisconnectCall = false;
			bRetrieveCall = true;
		}
	...
	if( strCallCount == "2")
	{		
		if(strStatus1 == "TLPCTI_EVENT_ID_SERVICE_INITIATED" || strStatus1 == "TLPCTI_EVENT_ID_NETWORKREACHED")
		{
			bDisconnectCall = true;
		}
		else if (strStatus1 == "TLPCTI_EVENT_ID_DIALING" || strStatus1 == "TLPCTI_EVENT_ID_DIALING_FORWARD" || strStatus1 == "TLPCTI_EVENT_ID_FAILED")
		{
			bTransferCall = true;
			bReconnectCall = true;
		}							
		else if( strStatus1 == "TLPCTI_EVENT_ID_CONNECTED")
		{
			bTransferCall = true;
			bReconnectCall = true;
...
function ProcEvent(objJsonMsg)
{
	...
	if(valID == "TELPER_AGTSTATE_CTI_LOGIN")
	{
		var telno = objJsonMsg.BODY.TELNO;
	...
	else if(valID == "TELPER_AGTSTATE_CTI_LOGOUT")
	{
		var telno = objJsonMsg.BODY.TELNO;
		var ctiid = objJsonMsg.BODY.CTI_ID;
	...
	else if(valID == "TELPER_AGTSTATE_CTI_AVAIL")
	{
		var telno = objJsonMsg.BODY.TELNO;
		var ctiid = objJsonMsg.BODY.CTI_ID;
	...
	else if(valID == "TELPER_AGTSTATE_CTI_UNAVAIL")
	{
		var substate = objJsonMsg.BODY.SUBSTATE;
		var telno = objJsonMsg.BODY.TELNO;
		var ctiid = objJsonMsg.BODY.CTI_ID;
		
		if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_0")
			message.ID = "UNAVAIL0";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_1")
			message.ID = "UNAVAIL1";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_2")
			message.ID = "UNAVAIL2";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_3")
			message.ID = "UNAVAIL3";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_4")
			message.ID = "UNAVAIL4";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_5")
			message.ID = "UNAVAIL5";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_6")
			message.ID = "UNAVAIL6";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_7")
			message.ID = "UNAVAIL7";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_8")
			message.ID = "UNAVAIL8";
		else if(substate == "TELPER_AGTSTATE_CTI_UNAVAIL_9")
			message.ID = "UNAVAIL9";
		message.KIND = "Event";
		message.TELNO = telno;
		message.CTIID = ctiid;
	...
	else if(valID == "TELPER_AGTSTATE_CTI_WORK")
	{
		var substate = objJsonMsg.BODY.SUBSTATE;
		var telno = objJsonMsg.BODY.TELNO;
		var ctiid = objJsonMsg.BODY.CTI_ID;
		
		if(substate == "TELPER_AGTSTATE_CTI_WORK_0")
			message.ID = "WORK0";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_1")
			message.ID = "WORK1";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_2")
			message.ID = "WORK2";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_3")
			message.ID = "WORK3";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_4")
			message.ID = "WORK4";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_5")
			message.ID = "WORK5";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_6")
			message.ID = "WORK6";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_7")
			message.ID = "WORK7";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_8")
			message.ID = "WORK8";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_9")
			message.ID = "WORK9";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_ACW")
			message.ID = "WORKACW";
		else if(substate == "TELPER_AGTSTATE_CTI_WORK_CTF")
			message.ID = "WORKCTF";
		message.KIND = "Event";
		message.TELNO = telno;
		message.CTIID = ctiid;
	...
	else if(valID == "TLPCTI_EVENT_ID_SERVICE_INITED")
	{
		...
		message.STATUS = status.AGENT_CALL_DETAIL_STATUS;
		message.CALLKEY = objJsonMsg.BODY.CALLKEY;
		message.TIME = objJsonMsg.BODY.EVENT_TIME;
		
		postMessage(message);		
	}
	else if(valID == "TLPCTI_EVENT_ID_ORIGINATED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_NETWORKREACHED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_ALERTED" || valID == "TLPCTI_EVENT_ID_ALERTED_FORWARD")
	{
		var status = objJsonMsg.BODY.STATUS;
		...
		{
			if(message.STATUS == "TrunkOutRing" || message.STATUS == "StationOutRing")
				message.INOUT = "OUT";
			else if(message.STATUS == "AcdInRing" || message.STATUS == "DirectAcdInRing" || message.STATUS == "StationInRing" )
				message.INOUT = "IN";
			else 
				message.INOUT = "NONE";
			message.OPPTELNO = status.OPPSITE_TELNO;
		}
		
		postMessage(message);
	}
	else if(valID == "TLPCTI_EVENT_ID_CONNECTED" || valID == "TLPCTI_EVENT_ID_CONNECTED_PICKUP")
	{
		var status = objJsonMsg.BODY.STATUS;
		...
		if(message.CALLCOUNT == '1')
		{
			if(message.STATUS == "TrunkOutConv" || message.STATUS == "StationOutConv")
				message.INOUT = "OUT";
			else if(status.AGENT_CALL_STATUS == "TLPCTI_AGTCALL_ACD" || message.STATUS == "DirectAcdInConv" || message.STATUS == "StationInConv")
				message.INOUT = "IN";
			else 
				message.INOUT = "NONE";
			message.OPPTELNO = status.OPPSITE_TELNO;	
	...
	else if(valID == "TLPCTI_EVENT_ID_HOLD")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_HELD")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_RETRIEVED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_DISCONNECTED")
	{
		var status = objJsonMsg.BODY.STATUS;
		...
		message.STATUS = status.AGENT_CALL_DETAIL_STATUS;
		message.CALLKEY = objJsonMsg.BODY.CALLKEY;
		message.RELEASING = objJsonMsg.BODY.RELEASING_TELNO;
		message.TIME = objJsonMsg.BODY.EVENT_TIME;
		
		postMessage(message);
	}
	else if(valID == "TLPCTI_EVENT_ID_CONNECTION_CLRED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_CONFERENCED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_CONFERENCED_HOLD")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_CONFERENCED_HELD")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_DVTED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_FAILED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_QUEUED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_XFERRED")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_OUT_OF_SERVICE")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_IN_SERVICE")
	{
		var status = objJsonMsg.BODY.STATUS;
	...
	else if(valID == "TLPCTI_EVENT_ID_POPUP")
	{
		message.ID = "POPUP";
		message.KIND = "Event";
		message.QUEUEDUR = objJsonMsg.BODY.QUEUE_DUR;
		message.CALLING = objJsonMsg.BODY.CALLING_TELNO;
		message.IVR_INFO = objJsonMsg.BODY.IVR_INFO;
		message.TIME = objJsonMsg.BODY.EVENT_TIME;
...
function ProcResp(objJsonMsg)
{
	...
	if(objJsonMsg.HEAD.ID == 'GetIvrInfo')
		message.IVRINFO = objJsonMsg.BODY.IVR_INFO;
...
{
	if(id == 'TELPER_AGTSTATE_CTI_LOGIN')
		return 'Login';
	else if(id == 'TELPER_AGTSTATE_CTI_LOGOUT')
		return 'Logout';
	else if(id == 'TELPER_AGTSTATE_CTI_AVAIL')
		return 'Avail';
	else if(id == 'TELPER_AGTSTATE_CTI_UNAVAIL')
	{
		if(substate == 'TELPER_AGTSTATE_CTI_UNAVAIL_0')
			return 'Unavail0';
		else if(substate == 'TELPER_AGTSTATE_CTI_UNAVAIL_1')
	...
	else if(id == 'TELPER_AGTSTATE_CTI_WORK')
	{
		if(substate == 'TELPER_AGTSTATE_CTI_WORK_0')
			return 'Work0';
		else if(substate == 'TELPER_AGTSTATE_CTI_WORK_1')
