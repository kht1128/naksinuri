 ...
 */
package egovframework.cti.mbrhstry.service;
 ...
 */
public class CtiMyHistoryVO extends EduDefaultVO {
	...
	private String CRS_PLACE;//교육장소
	private String CRS_ADDR;//교육장주소
	private String LRNNG_CMPLT_DT_STR;//교육이수일자 CTI포맷변환용
	private String CRTF_SN;//이수증번호 CTI이수증출력용
	private String CRTF_CD;//이수증코드 CTI이수증출력용
	...
	public String getLRNNG_CMPLT_DT_STR() {
		return LRNNG_CMPLT_DT_STR;
	}
	public void setLRNNG_CMPLT_DT_STR(String lRNNG_CMPLT_DT_STR) {
		LRNNG_CMPLT_DT_STR = lRNNG_CMPLT_DT_STR;
	}
