 ...
 * 테이블명 : 
 */
public class EduCenterMbrRemindersVO extends EduVO {
	...
	//디비외
	private String REQ_YN;			//문자요청 여부
	private String RMNDR_SIDO_NM;	//시도 이름
	private String RMNDR_SIGNGU_NM;	//시군구 이름
	...
	public String getRMNDR_SIDO_NM() {
		return RMNDR_SIDO_NM;
	}
	public void setRMNDR_SIDO_NM(String rMNDR_SIDO_NM) {
		RMNDR_SIDO_NM = rMNDR_SIDO_NM;
	}
	public String getRMNDR_SIGNGU_NM() {
		return RMNDR_SIGNGU_NM;
	}
	public void setRMNDR_SIGNGU_NM(String rMNDR_SIGNGU_NM) {
		RMNDR_SIGNGU_NM = rMNDR_SIGNGU_NM;
	}
