...
public class EgovDefaultPaginationRenderer extends AbstractPaginationRenderer {
	...
	*/
	public void initVariables(PaginationInfo paginationInfo) {
		...
		firstPageLabel = "<li><a href=\"#;\" aria-label=\"Previous\" onclick=\"{0}({1}); return false;\"><i class=\"fa fa-angle-double-left\"></i></a></li>"; 
		previousPageLabel = "<li><a href=\"#;\" aria-label=\"Previous\" onclick=\"{0}({1}); return false;\"><i class=\"fa fa-angle-left\"></i></a></li>";
		currentPageLabel = "<li class=\"active\"><a href=\"#;\">{0}</a></li>";
		otherPageLabel = "<li><a href=\"#;\" onclick=\"{0}({1}); return false;\">{2}</a></li>";
		nextPageLabel = "<li><a href=\"#;\" aria-label=\"Next\" onclick=\"{0}({1}); return false;\"><i class=\"fa fa-angle-right\"></i></a></li>";
		lastPageLabel = "<li><a href=\"#;\" aria-label=\"Next\" onclick=\"{0}({1}); return false;\"><i class=\"fa fa-angle-double-right\"></i></a></li>";
