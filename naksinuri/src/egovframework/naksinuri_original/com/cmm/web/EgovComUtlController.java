...
public class EgovComUtlController {
	 ...
	 */
	@RequestMapping(value = "/naksinuri_original/EgovPageLink.do")
	public String moveToPage(@RequestParam("link") String linkPage, HttpSession session, @RequestParam(value = "menuNo", required = false) String menuNo) {
		...
		if (linkPage == null || linkPage.equals("")) {
			link = "naksinuri_original/cmm/egovError";
		} else {
			if (link.indexOf(",") > -1) {
	 ...
	 * JSP 호출작업만 처리하는 공통 함수
	 */
	@RequestMapping(value = "/naksinuri_original/EgovPageLink.action")
	 ...
	 */
	@RequestMapping("/naksinuri_original/validator.do")
	public String validate() {
		return "naksinuri_original/cmm/validator";
	}
